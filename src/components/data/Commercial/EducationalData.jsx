...
export const EducationalData = [
  // BUY - Luxury Villa (Posted by OWNER)
  {
    ...
    highlights: "Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa |Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa",
  ...
  // RENT - Sea View Villa (Posted by OWNER)
  {
    ...
    highlights: "Fully Furnished | 3 BHK | Sea View | Beach Villa Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa | Fully Furnished | 5+ BHK | Ready to Move | Luxury Villa",
    postedBy: "Anaya Dev",
    postedAs: "Owner",
  ...
  // RENT - Heritage Villa (Posted by AGENT)
  {
    ...
    agentDetails: "🏛️ Heritage property specialist | Verified agent | Best Educational deals in Mylapore",
