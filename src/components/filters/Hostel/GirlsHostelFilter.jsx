...
// Main Component
const GirlsHostelFilter = ({ activeTab = 'Buy', onFilterChange, onClose, onTabChange }) => {
  ...
  const applyFilters = () => {
    const filtersToSend = { ...filters, purpose: currentTab, propertyType: 'Girls Hostel' };
  ...
  const renderBasicDetails = () => (
    <div className="space-y-3">
      <div>
        ...
        <input type="text" value="Girls Hostel" disabled className="w-full px-3 py-2 rounded-xl border-2 border-teal-200 bg-gray-50/80 text-sm text-gray-600" />
      </div>
      <div>
...
export default GirlsHostelFilter;