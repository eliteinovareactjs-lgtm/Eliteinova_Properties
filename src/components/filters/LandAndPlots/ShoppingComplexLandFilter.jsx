...
import { 
  ...
  Square, Home, Bus, CheckCircle, TrendingUp, Clock, Store, 
...
const ShoppingComplexLandFilter = ({ activeTab = 'Rent', onFilterChange, onClose, onTabChange }) => {
  const [currentTab, setCurrentTab] = useState(activeTab);
  const [activeMainSection, setActiveMainSection] = useState('basic');
  
  const [filters, setFilters] = useState({
    listingType: [],
    city: '', area: '', landmark: '', pincode: '', mainRoadFacing: '', highwayAccess: '', cornerLand: '',
    nearbyConnectivity: '',
    ...
    landArea: '', landAreaUnit: 'sqft', plotLength: '', plotWidth: '', facing: '', roadWidth: '', boundaryWall: '', plotShape: '',
    minRoadWidthRequired: '', plotShapePreference: '',
    dtcpApproved: '', cmdaApproved: '', reraApproved: '', commercialApproval: '', pattaAvailable: '', encumbranceFree: '',
    rentalAgreementReady: '', leaseAgreementReady: '', loanEligible: '', titleDeedVerified: '',
    waterConnection: '', electricityConnection: '', drainageFacility: '', streetLights: '', parkingSpace: '', internetBroadband: '', heavyVehicleAccess: '',
    gatedCommercialLayout: '', security24x7: '', cctvSurveillance: '', visitorParking: '', wideFrontage: '', fireSafety: '', liftEscalator: '',
    suitableForTypes: [],
  ...
  const suitableForOptions = {
    rent: [
      'Retail Shopping Complex', 'Supermarket / Hypermarket', 'Multi-brand Outlet',
      'Food Court Setup', 'Entertainment Zone', 'Mall Development',
      'Commercial Plaza', 'Franchise Business Space'
    ],
    buy: [
      'Retail Shopping Complex', 'Supermarket / Hypermarket', 'Multi-brand Outlet',
      'Food Court Setup', 'Entertainment Zone', 'Mall Development',
  ...
  const nearbyOptions = [
    ...
    'Commercial Hub', 'Shopping Zone', 'Highway Access'
  ];
  ...
  const mainSections = [
    ...
    { id: 'suitable', label: '🏗️ Suitable', icon: <Store className="w-3.5 h-3.5" /> },
  ...
  const applyFilters = () => {
    const filtersToSend = { ...filters, purpose: currentTab, propertyType: 'Shopping Complex Land' };
  ...
  const clearAllFilters = () => {
    setFilters({
      listingType: [], city: '', area: '', landmark: '', pincode: '', mainRoadFacing: '', highwayAccess: '', cornerLand: '',
      nearbyConnectivity: '',
      minRent: '', maxRent: '', securityDeposit: '', advanceAmount: '', maintenanceIncluded: '', rentNegotiable: '',
      minBudget: '', maxBudget: '', preferredPricePerSqft: '', loanRequired: '', priceNegotiable: '',
      minSellPrice: '', maxSellPrice: '', pricePerSqft: '', sellPriceNegotiable: '', maintenanceCharges: '', propertyTax: '',
    ...
    <div className="space-y-3">
      <div className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg p-3 border border-teal-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div>
            ...
            <input type="text" value="Shopping Complex Land" disabled className="w-full px-2 py-1.5 rounded border border-teal-300 bg-gray-50 text-xs text-gray-600" />
          </div>
          <div>
      ...
      <div className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg p-3 border border-teal-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          ...
          <input type="text" placeholder="Area / Commercial Zone / Locality" className="w-full px-2 py-1.5 rounded border border-teal-300 bg-white text-xs focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500" value={filters.area} onChange={(e) => handleInputChange('area', e.target.value)} />
  ...
  const renderUtilitiesSection = () => (
    <div className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg p-3 border border-teal-200">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
        ...
        <YesNoRadioGroup label="Street Lights" name="streetLights" value={filters.streetLights} onChange={(val) => handleRadioChange('streetLights', val)} />
  ...
  const renderAmenitiesSection = () => (
    <div className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg p-3 border border-teal-200">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
        <YesNoRadioGroup label="Gated Commercial Layout" name="gatedCommercialLayout" value={filters.gatedCommercialLayout} onChange={(val) => handleRadioChange('gatedCommercialLayout', val)} />
        ...
        <YesNoRadioGroup label="Visitor Parking" name="visitorParking" value={filters.visitorParking} onChange={(val) => handleRadioChange('visitorParking', val)} />
        <YesNoRadioGroup label="Wide Frontage Access" name="wideFrontage" value={filters.wideFrontage} onChange={(val) => handleRadioChange('wideFrontage', val)} />
        ...
        <YesNoRadioGroup label="Lift / Escalator Provision" name="liftEscalator" value={filters.liftEscalator} onChange={(val) => handleRadioChange('liftEscalator', val)} />
      </div>
    </div>
  );
  ...
  const renderSuitableSection = () => {
    ...
    return (
      <div className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg p-3 border border-teal-200">
        <h3 className="font-semibold text-teal-800 mb-2 flex items-center gap-1.5 text-sm"><Store className="w-3.5 h-3.5" /> Shopping Complex Suitability</h3>
          ...
          <div className="flex justify-between items-center px-3 py-2 bg-gradient-to-r from-teal-600 to-emerald-700">
            <div className="flex items-center gap-2">
              <div className="p-0.5 bg-white/20 rounded">
                <Store className="w-4 h-4 text-white slow-rotate" />
              </div>
              <h3 className="text-white font-semibold text-lg">Filter Shopping Complex Land</h3>
            </div>
            {onClose && (
