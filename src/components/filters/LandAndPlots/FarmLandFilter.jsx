...
const FarmLandAreaUnitSelect = ({ value, onChange }) => {
  const [isOpen, setIsOpen] = useState(false);
  const selectRef = useRef(null);
  const units = [
...
const FarmLandFilter = ({ activeTab = 'Rent', onFilterChange, onClose, onTabChange }) => {
  ...
  const farmSuitabilityOptions = [
    'Crop Farming', 'Organic Farming', 'Coconut Farm', 'Banana Plantation',
    'Mango / Fruit Orchard', 'Dairy Farming', 'Poultry Farming', 'Goat / Sheep Farming',
    'Fish Farming', 'Farm Stay / Eco Tourism'
  ];
  ...
  const amenitiesOptions = [
    'Gated Farm Land', 'Security / Caretaker', 'Drip Irrigation Setup',
  ...
  const mainSections = [
    ...
    { id: 'farmSuitability', label: '🌱 Farm Use', icon: <Leaf className="w-3.5 h-3.5" /> },
  ...
  const applyFilters = () => {
    const filtersToSend = { ...filters, purpose: currentTab, propertyType: 'Farm Land' };
      ...
      <div className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg p-3 border border-teal-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div>
            ...
            <input type="text" value="Farm Land" disabled className="w-full px-2 py-1.5 rounded border border-teal-300 bg-gray-50 text-xs text-gray-600" />
          </div>
          <div>
    ...
    <div className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg p-3 border border-teal-200">
      ...
      <div className="space-y-2">
        <div className="grid grid-cols-4 gap-2 items-end">
          ...
          <FarmLandAreaUnitSelect value={filters.landAreaUnit} onChange={(val) => handleInputChange('landAreaUnit', val)} />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
        ...
        <div className="sticky top-0 z-10 bg-white border-b border-teal-100">
          <div className="flex justify-between items-center px-3 py-2 bg-gradient-to-r from-teal-600 to-emerald-700">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-white font-semibold text-sm">Filter Farm Land</h3>
            </div>
            {onClose && (
