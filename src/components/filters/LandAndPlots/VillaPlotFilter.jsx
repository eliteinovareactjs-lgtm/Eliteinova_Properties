...
const VillaPlotFilter = ({ activeTab = 'Buy', onFilterChange, onClose, onTabChange }) => {
  ...
  const communityFeaturesOptions = [
    'Gated Community', '24/7 Security', 'CCTV Surveillance', 'Compound Wall',
    'Wide Internal Roads', 'Street Lights', 'Underground Drainage',
  ...
  // SELL OPTION COMMENTED OUT IN SUITABLE FOR
  const suitableForOptions = {
    rent: [
      'Villa Construction', 'Luxury Residential Use', 'Weekend Home Setup',
      'Investment Purpose', 'Garden / Nursery', 'Temporary Residential Setup'
    ],
    buy: [
      'Luxury Villa Construction', 'Duplex Villa Construction', 'Weekend Home',
      'Investment Purpose', 'Rental Villa Development', 'Premium Residential Project'
    ],
    // sell: [
    //   'Luxury Villa Construction', 'Duplex Villa Construction', 'Weekend Home',
    //   'Investment Purpose', 'Rental Villa Development', 'Premium Residential Project'
    // ],
    lease: [
      'Luxury Villa Construction', 'Duplex Villa Construction', 'Weekend Home Setup',
      'Investment Purpose', 'Rental Villa Development', 'Premium Residential Project'
    ]
  };
  ...
  const applyFilters = () => {
    const filtersToSend = { ...filters, purpose: currentTab, propertyType: 'Villa Plot' };
    ...
    <div className="space-y-3">
      <div className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg p-3 border border-teal-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div>
            ...
            <input type="text" value="Villa Plot" disabled className="w-full px-2 py-1.5 rounded border border-teal-300 bg-gray-50 text-xs text-gray-600" />
          </div>
          <div>
      ...
      <div className="bg-gradient-to-r from-teal-50 to-emerald-50 rounded-lg p-3 border border-teal-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          ...
          <input type="text" placeholder="Villa Community / Layout Name" className="w-full px-2 py-1.5 rounded border border-teal-300 bg-white text-xs focus:outline-none focus:border-teal-500 focus:ring-1 focus:ring-teal-500" value={filters.communityName} onChange={(e) => handleInputChange('communityName', e.target.value)} />
        ...
        <div className="sticky top-0 z-10 bg-white border-b border-teal-100">
          <div className="flex justify-between items-center px-3 py-2 bg-gradient-to-r from-teal-600 to-emerald-700">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-white font-semibold text-sm">Filter Villa Plot</h3>
            </div>
            {onClose && (
...
export default VillaPlotFilter;