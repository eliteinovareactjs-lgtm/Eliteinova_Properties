...
const ITParkFilter = ({ activeTab = 'Buy', onFilterChange, onClose, onTabChange }) => {
  ...
  const [filters, setFilters] = useState({
    ...
    meetingRooms: '', conferenceHall: '', parkingCapacity: '',
    propertyAge: '', ownershipType: '',
    // Office Features
    furnishingType: '',
    plugAndPlaySetup: false, workstationsAvailable: false, serverRoom: false,
    receptionArea: false, pantryCafeteria: false, centralizedAc: false,
    highSpeedInternet: false, accessControlSystem: false, washrooms: false,
    // Amenities
    twentyFourSevenSecurity: false, cctvSurveillance: false, powerBackup: false,
    generatorBackup: false, liftEscalator: false, fireSafetySystem: false,
    visitorParking: false, foodCourtCafeteria: false, housekeepingServices: false,
    gymRecreationArea: false,
    ...
    leaseRenewalOption: '',
    // Legal Details
    commercialLicense: '', fireSafetyApproved: '', internetInfrastructureReady: '',
  ...
  // businessTypeOptions - Now Rocket is defined above, so this will work
  const businessTypeOptions = [
    { icon: <Laptop className="w-3 h-3" />, label: 'IT Companies' },
    { icon: <Cpu className="w-3 h-3" />, label: 'Software Development' },
  ...
  const applyFilters = () => {
    const filtersToSend = { ...filters, purpose: currentTab, propertyType: 'IT Park / Tech Park Space' };
      ...
      {expandedSections.basic && (
        <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          <div>
            ...
            <input type="text" value="IT Park / Tech Park Space" disabled className="w-full px-2 py-1 rounded-lg border-2 border-teal-300 bg-gray-50 text-sm text-gray-600" />
          </div>
          <div>
      ...
      {expandedSections.officeFeatures && (
        <div className="mt-2 space-y-3 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.plugAndPlaySetup} onChange={(e) => handleCheckboxChange('plugAndPlaySetup', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <Zap className="w-3 h-3 text-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Plug-and-Play Setup</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.workstationsAvailable} onChange={(e) => handleCheckboxChange('workstationsAvailable', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <Laptop className="w-3 h-3 text-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Workstations Available</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
              ...
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Server Room</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
            ...
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.accessControlSystem} onChange={(e) => handleCheckboxChange('accessControlSystem', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <Key className="w-3 h-3 text-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Access Control System</span>
            </label>
        ...
        <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          <div className="grid grid-cols-2 gap-1.5">
            ...
            <label className="flex items-center gap-1.5 cursor-pointer group">
              ...
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Lift / Escalator</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
            ...
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.foodCourtCafeteria} onChange={(e) => handleCheckboxChange('foodCourtCafeteria', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <Utensils className="w-3 h-3 text-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Food Court / Cafeteria</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
            ...
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.gymRecreationArea} onChange={(e) => handleCheckboxChange('gymRecreationArea', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <Dumbbell className="w-3 h-3 text-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Gym / Recreation Area</span>
            </label>
          </div>
        </div>
      )}
        ...
        <div className="mb-3">
          ...
          {expandedSections.legal && (
            <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
              ...
              <div>
                <label className="text-sm text-teal-800 font-medium block mb-2">Internet Infrastructure Ready</label>
                <div className="flex gap-3">
                  <label className="flex items-center gap-1.5 cursor-pointer group">
                    <input type="radio" name="internetInfrastructureReady" value="Yes" checked={filters.internetInfrastructureReady === 'Yes'} onChange={(e) => handleRadioChange('internetInfrastructureReady', e.target.value)} className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
                    <span className="text-xs text-teal-700 group-hover:text-teal-600">Yes</span>
                  </label>
                  <label className="flex items-center gap-1.5 cursor-pointer group">
                    <input type="radio" name="internetInfrastructureReady" value="No" checked={filters.internetInfrastructureReady === 'No'} onChange={(e) => handleRadioChange('internetInfrastructureReady', e.target.value)} className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
                    <span className="text-xs text-teal-700 group-hover:text-teal-600">No</span>
                  </label>
                </div>
              </div>
          ...
          {expandedSections.legal && (
            <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <label className="flex items-center gap-1.5 cursor-pointer group">
                    <input type="radio" name="internetInfrastructureReadyLease" value="Yes" checked={filters.internetInfrastructureReady === 'Yes'} onChange={(e) => handleRadioChange('internetInfrastructureReady', e.target.value)} className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
                    <span className="text-xs text-teal-700 group-hover:text-teal-600">Yes</span>
                  </label>
                  <label className="flex items-center gap-1.5 cursor-pointer group">
                    <input type="radio" name="internetInfrastructureReadyLease" value="No" checked={filters.internetInfrastructureReady === 'No'} onChange={(e) => handleRadioChange('internetInfrastructureReady', e.target.value)} className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
                    <span className="text-xs text-teal-700 group-hover:text-teal-600">No</span>
                  </label>
                </div>
              </div>
          ...
          {expandedSections.legal && (
            <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <label className="flex items-center gap-1.5 cursor-pointer group">
                    <input type="radio" name="internetInfrastructureReadyRent" value="Yes" checked={filters.internetInfrastructureReady === 'Yes'} onChange={(e) => handleRadioChange('internetInfrastructureReady', e.target.value)} className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
                    <span className="text-xs text-teal-700 group-hover:text-teal-600">Yes</span>
                  </label>
                  <label className="flex items-center gap-1.5 cursor-pointer group">
                    <input type="radio" name="internetInfrastructureReadyRent" value="No" checked={filters.internetInfrastructureReady === 'No'} onChange={(e) => handleRadioChange('internetInfrastructureReady', e.target.value)} className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
                    <span className="text-xs text-teal-700 group-hover:text-teal-600">No</span>
                  </label>
                </div>
              </div>
        ...
        <div className="flex justify-between items-center px-4 py-2.5 bg-gradient-to-r from-teal-600 to-emerald-600">
          <div className="flex items-center gap-2">
            <div className="p-1 bg-white/20 rounded-lg">
              ...
              `}</style>
              <Cpu className="w-5 h-5 text-white slow-rotate" />
            </div>
            <h3 className="text-white font-semibold text-sm md:text-base">Filter IT Park / Tech Park Space</h3>
          </div>
