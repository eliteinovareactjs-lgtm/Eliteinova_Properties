...
const ShoppingMallSpaceFilter = ({ activeTab = 'Buy', onFilterChange, onClose, onTabChange }) => {
  ...
  const [filters, setFilters] = useState({
    ...
    mainRoadFacing: '', cornerUnit: '',
    nearbyConnectivity: '',
    // Budget/Price Details
    minPrice: '', maxPrice: '', priceNegotiable: '', loanRequired: '', maintenanceCharges: '', propertyTax: '',
    ...
    floorNumber: '', totalMallFloors: '',
    shopFrontageWidth: '', ceilingHeight: '', parkingAvailability: '',
    propertyAge: '', ownershipType: '',
    // Space Features
    furnishingType: '',
    displayArea: false, storageRoom: false, washroom: false,
    pantry: false, airConditioning: false, signageSpace: false,
    billingCounterArea: false, escalatorLiftAccess: false, loadingUnloadingAccess: false,
    // Amenities
    twentyFourSevenSecurity: false, cctvSurveillance: false, powerBackup: false,
    fireSafetySystem: false, visitorParking: false, centralizedAc: false,
    escalatorLift: false, foodCourtAccess: false, housekeepingServices: false,
    internetBroadband: false,
  ...
  const businessTypeOptions = [
    { icon: <Shirt className="w-3 h-3" />, label: 'Clothing Store' },
    { icon: <Tv className="w-3 h-3" />, label: 'Electronics Store' },
    { icon: <Gem className="w-3 h-3" />, label: 'Jewelry Store' },
    { icon: <Utensils className="w-3 h-3" />, label: 'Food Court / Restaurant' },
    { icon: <Smartphone className="w-3 h-3" />, label: 'Mobile Showroom' },
    { icon: <ShoppingBag className="w-3 h-3" />, label: 'Supermarket' },
    { icon: <Store className="w-3 h-3" />, label: 'Franchise Outlet' },
    { icon: <Gamepad className="w-3 h-3" />, label: 'Entertainment Zone' }
  ];

  const nearbyOptions = [
    'Metro / Bus Stop', 'Residential Area', 'Commercial Hub',
    'Highway Access', 'Bank / ATM Nearby', 'Parking Zone'
  ];
  ...
  const applyFilters = () => {
    const filtersToSend = { ...filters, purpose: currentTab, propertyType: 'Shopping Mall Space' };
      ...
      {expandedSections.basic && (
        <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          <div>
            ...
            <input type="text" value="Shopping Mall Space" disabled className="w-full px-2 py-1 rounded-lg border-2 border-teal-300 bg-gray-50 text-sm text-gray-600" />
          </div>
          <div>
      ...
      {expandedSections.location && (
        <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="text-sm text-teal-800 font-medium block mb-2">Corner Unit</label>
              <div className="flex gap-3">
                <label className="flex items-center gap-1.5 cursor-pointer group">
                  <input type="radio" name="cornerUnit" value="Yes" checked={filters.cornerUnit === 'Yes'} onChange={(e) => handleRadioChange('cornerUnit', e.target.value)} className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
                  <span className="text-xs text-teal-700 group-hover:text-teal-600">Yes</span>
                </label>
                <label className="flex items-center gap-1.5 cursor-pointer group">
                  <input type="radio" name="cornerUnit" value="No" checked={filters.cornerUnit === 'No'} onChange={(e) => handleRadioChange('cornerUnit', e.target.value)} className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
                  <span className="text-xs text-teal-700 group-hover:text-teal-600">No</span>
                </label>
              </div>
            </div>
      ...
      {expandedSections.property && (
        <div className="mt-2 space-y-3 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="text-sm text-teal-800 font-medium block mb-1">Total Mall Floors</label>
              <input type="number" placeholder="Total floors in mall" className="w-full px-2 py-1.5 rounded-lg border-2 border-teal-300 bg-white text-sm focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500" value={filters.totalMallFloors} onChange={(e) => handleInputChange('totalMallFloors', e.target.value)} />
            </div>
          </div>

          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="text-sm text-teal-800 font-medium block mb-1">Shop Frontage Width (ft)</label>
              <input type="number" placeholder="Enter frontage width" className="w-full px-2 py-1.5 rounded-lg border-2 border-teal-300 bg-white text-sm focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500" value={filters.shopFrontageWidth} onChange={(e) => handleInputChange('shopFrontageWidth', e.target.value)} />
            </div>
            <div>
          ...
          {(currentTab === 'Buy' || currentTab === 'Rent' || currentTab === 'Sell' || currentTab === 'Lease') && (
  ...
  const renderSpaceFeatures = () => (
    <div className="mb-3">
      <SectionHeader emoji="🛍️" title="Space Features" section="spaceFeatures" />
      {expandedSections.spaceFeatures && (
        <div className="mt-2 space-y-3 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          <div>
          ...
          <div className="grid grid-cols-2 gap-1.5">
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.displayArea} onChange={(e) => handleCheckboxChange('displayArea', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Display Area / Showcase</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
            ...
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.billingCounterArea} onChange={(e) => handleCheckboxChange('billingCounterArea', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Billing Counter Area</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.escalatorLiftAccess} onChange={(e) => handleCheckboxChange('escalatorLiftAccess', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Escalator / Lift Access</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group col-span-2">
              <input type="checkbox" checked={filters.loadingUnloadingAccess} onChange={(e) => handleCheckboxChange('loadingUnloadingAccess', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
      ...
      {expandedSections.amenities && (
        <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          <div className="grid grid-cols-2 gap-1.5">
            ...
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.escalatorLift} onChange={(e) => handleCheckboxChange('escalatorLift', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <Building2 className="w-3 h-3 text-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Escalator / Lift</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.foodCourtAccess} onChange={(e) => handleCheckboxChange('foodCourtAccess', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <Utensils className="w-3 h-3 text-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Food Court Access</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
      ...
      <div className="sticky top-0 z-10 bg-white border-b-2 border-teal-100">
        <div className="flex justify-between items-center px-4 py-2.5 bg-gradient-to-r from-teal-600 to-emerald-600">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-white font-semibold text-sm md:text-base">Filter Shopping Mall Space</h3>
          </div>
...
export default ShoppingMallSpaceFilter;