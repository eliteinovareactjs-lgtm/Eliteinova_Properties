...
import { 
  ...
  Store, Zap, Droplet, Wifi, Lamp, Fence, Truck,
  Car, Tv, Sofa, Shirt, Gem, Smartphone, Briefcase
} from 'lucide-react';
...
const ShowroomFilter = ({ activeTab = 'Buy', onFilterChange, onClose, onTabChange }) => {
  ...
  const [filters, setFilters] = useState({
    ...
    parkingCapacity: '', propertyAge: '', ownershipType: '',
    furnishingType: '',
    displayArea: false, storageRoom: false, trialRooms: false,
    billingCounter: false, washrooms: false, pantry: false,
    airConditioning: false, signageSpace: false, loadingUnloading: false,
    elevatorAccess: false,
    security24x7: false, cctv: false, powerBackup: false,
    fireSafety: false, visitorParking: false, internetBroadband: false,
    generatorBackup: false, liftEscalator: false, housekeeping: false,
    businessTypes: [],
    ...
    minPrice: '', maxPrice: '', priceNegotiable: '', maintenanceCharges: '',
    propertyTax: '', loanRequired: '',
  ...
  const floorOptions = [
    ...
    { value: 'Multi-floor', label: 'Multi-floor' }
  ];
  ...
  const businessTypeOptions = [
    { icon: <Car className="w-3 h-3" />, label: 'Automobile Showroom' },
    { icon: <Smartphone className="w-3 h-3" />, label: 'Electronics Showroom' },
    { icon: <Sofa className="w-3 h-3" />, label: 'Furniture Showroom' },
    { icon: <Shirt className="w-3 h-3" />, label: 'Fashion / Clothing Showroom' },
    { icon: <Gem className="w-3 h-3" />, label: 'Jewelry Showroom' },
    { icon: <Tv className="w-3 h-3" />, label: 'Home Appliances Showroom' },
    { icon: <Briefcase className="w-3 h-3" />, label: 'Franchise Outlet' }
  ];

  const nearbyOptions = [
    'Market Area', 'Bus Stop / Metro', 'Residential Hub', 
    'Commercial Hub', 'Highway Access', 'Bank / ATM Nearby', 'Parking Zone'
  ];
  ...
  const applyFilters = () => {
    const filtersToSend = { ...filters, purpose: currentTab, propertyType: 'Showroom' };
      ...
      {expandedSections.basic && (
        <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          <div>
            ...
            <input type="text" value="Showroom" disabled className="w-full px-2 py-1 rounded-lg border-2 border-teal-300 bg-gray-50 text-sm text-gray-600" />
          </div>
          <div>
          ...
          <div>
            ...
            <div className="flex gap-3">
               <label className="flex items-center gap-1.5 cursor-pointer group">
                <input 
                  type="radio" 
                  name="mainRoadFacingGroup" 
                  value="Yes" 
                  checked={filters.mainRoadFacing === 'Yes'} 
                  onChange={() => handleRadioChange('mainRoadFacing', 'Yes')} 
                  className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" 
                />
              ...
              <label className="flex items-center gap-1.5 cursor-pointer group">
                <input 
                  ...
                  name="mainRoadFacingGroup" 
                  value="No" 
                  checked={filters.mainRoadFacing === 'No'} 
                  onChange={() => handleRadioChange('mainRoadFacing', 'No')} 
                  className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" 
                />
            ...
            <div className="flex gap-3">
              <label className="flex items-center gap-1.5 cursor-pointer group">
                <input 
                  type="radio" 
                  name="cornerPropertyGroup" 
                  value="Yes" 
                  checked={filters.cornerProperty === 'Yes'} 
                  onChange={() => handleRadioChange('cornerProperty', 'Yes')} 
                  className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" 
                />
                <span className="text-xs text-teal-700 group-hover:text-teal-600">Yes</span>
              </label>
              <label className="flex items-center gap-1.5 cursor-pointer group">
                <input 
                  ...
                  name="cornerPropertyGroup" 
                  value="No" 
                  checked={filters.cornerProperty === 'No'} 
                  onChange={() => handleRadioChange('cornerProperty', 'No')} 
                  className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" 
                />
                <span className="text-xs text-teal-700 group-hover:text-teal-600">No</span>
              </label>
  ...
  const renderShowroomFeatures = () => (
    <div className="mb-3">
      <SectionHeader emoji="🛍️" title="Showroom Features" section="showroomFeatures" />
      {expandedSections.showroomFeatures && (
        <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          <div>
          ...
          <div className="grid grid-cols-2 gap-1.5">
            ...
            <label className="flex items-center gap-1.5 cursor-pointer group">
              ...
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Storage / Inventory Room</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.trialRooms} onChange={(e) => handleCheckboxChange('trialRooms', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Trial Rooms</span>
            </label>
            <label className="flex items-center gap-1.5 cursor-pointer group">
            ...
            <label className="flex items-center gap-1.5 cursor-pointer group">
              <input type="checkbox" checked={filters.elevatorAccess} onChange={(e) => handleCheckboxChange('elevatorAccess', e.target.checked)} className="w-3.5 h-3.5 rounded border-2 border-teal-300 bg-white checked:bg-teal-600 checked:border-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
              <span className="text-xs text-teal-700 group-hover:text-teal-600">Elevator / Escalator Access</span>
            </label>
          </div>
        </div>
      )}
      ...
      {expandedSections.price && (
        <div className="mt-2 space-y-2 bg-teal-50 rounded-lg border-2 border-teal-200 p-3">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <label className="flex items-center gap-1.5 cursor-pointer group">
                <input type="radio" name="maintenanceIncluded" value="Yes" checked={filters.maintenanceIncluded === 'Yes'} onChange={(e) => handleRadioChange('maintenanceIncluded', e.target.value)} className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
                <span className="text-xs text-teal-700 group-hover:text-teal-600">Yes</span>
              </label>
              <label className="flex items-center gap-1.5 cursor-pointer group">
                <input type="radio" name="maintenanceIncluded" value="No" checked={filters.maintenanceIncluded === 'No'} onChange={(e) => handleRadioChange('maintenanceIncluded', e.target.value)} className="w-3.5 h-3.5 border-2 border-teal-300 text-teal-600 focus:ring-0 focus:ring-offset-0 focus:outline-none accent-teal-600" />
                <span className="text-xs text-teal-700 group-hover:text-teal-600">No</span>
              </label>
            </div>
          </div>
      ...
      <div className="sticky top-0 z-10 bg-white border-b-2 border-teal-100">
        <div className="flex justify-between items-center px-4 py-2.5 bg-gradient-to-r from-teal-600 to-emerald-600">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-white font-semibold text-sm md:text-base">Filter Showroom</h3>
          </div>
