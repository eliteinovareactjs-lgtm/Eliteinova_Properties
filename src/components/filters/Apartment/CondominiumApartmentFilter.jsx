...
import { 
  ...
  Gauge, Key, Lock, LayoutTemplate, Gem, Building2, X, RefreshCw
} from 'lucide-react';
...
const CondominiumApartmentFilter = ({ activeTab = 'Rent', onFilterChange, onClose }) => {
        ...
        <div className="px-3 py-1.5 sm:px-6 sm:py-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <h1 className="text-sm sm:text-base md:text-lg font-bold text-white">Condominium Apartment Filters</h1>
            </div>
            {onClose && (
              <button 
                onClick={onClose} 
