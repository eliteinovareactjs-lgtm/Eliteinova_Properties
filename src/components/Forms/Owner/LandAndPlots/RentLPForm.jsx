...
export default function RentLPForm({ isOpen, onClose }) {
  ...
  const validateStep = (s) => {
    ...
    if (s === 3) {
      ...
      else if (!isOnlyNumbers(formData.securityDeposit)) e.securityDeposit = "Only numbers allowed";
    }
    if (s === 4) {
