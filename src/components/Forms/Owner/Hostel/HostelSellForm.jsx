...
export default function HostelSellForm({ isOpen, onClose }) {
  ...
  const validateStep = (s) => {
    ...
    if (s === 2) {
      ...
      if (!formData.constructionStatus) e.constructionStatus = "Please select construction status";
      if (!formData.ownershipType) e.ownershipType = "Please select ownership type";
    }
    if (s === 3) {
    ...
    if (s === 5) {
      ...
      if (!formData.pattaChitta) e.pattaChitta = "Patta/Chitta is required";
      ...
      if (!formData.completionCertificate) e.completionCertificate = "Completion certificate is required";
      if (!formData.occupancyCertificate) e.occupancyCertificate = "Occupancy certificate is required";
      if (!formData.propertyTaxReceipt) e.propertyTaxReceipt = "Property tax receipt is required";
    }
    if (s === 6) {
...
function MobContentSell({ 
  ...
  if (step === 5) return (
    <>
      ...
      <Field label="Patta / Chitta" required error={errors.pattaChitta}>
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
...
function DtContentSell({ 
  ...
  if (step === 5) return (
    <>
      ...
      <FieldDt label="Patta / Chitta" required error={errors.pattaChitta}>
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
