  ...
  if (step === 5) return (
    <>
      ...
      <Field label="Monthly Rent (₹)" required error={errors.rent}>
        <input className={`${inp} ${errors.rent ? errorBorder : ''}`} type="number" min="0" placeholder="Enter monthly rent" value={formData.rent} onChange={(e) => updateForm("rent", e.target.value)} />
      </Field>
