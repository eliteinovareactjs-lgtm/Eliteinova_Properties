...
export default function SellPMComForm({ isOpen, onClose }) {
  ...
  const [formData, setFormData] = useState({
    ...
    listingPurpose: "sale", sellPrice: "", priceType: "fixed",
    ...
    saleDeed: null, encumbranceCertificate: null, propertyTaxReceipt: null,
    buildingApprovalPlan: null, occupancyCertificate: null, tradeLicense: null,
  ...
  const handleAlphaNumericChange = (field, value) => {
    ...
    switch(stepIndex) {
      ...
      case 1: // Authorized Representative
        if (!formData.authFullName.trim()) {
          ...
          newErrors.authFullName = "Only letters and spaces allowed";
          isValid = false;
        }
      ...
      case 2: // Office Address
        ...
        if (!formData.officeCity.trim()) {
          ...
          newErrors.officeCity = "Only letters and spaces allowed";
          isValid = false;
        }
        if (!formData.officeDistrict.trim()) {
          ...
          newErrors.officeDistrict = "Only letters and spaces allowed";
          isValid = false;
        }
        if (!formData.officeState.trim()) {
          ...
          newErrors.officeState = "Only letters and spaces allowed";
          isValid = false;
        }
        if (!formData.officePinCode || !validatePinCode(formData.officePinCode)) {
      ...
      case 4: // Property Details
        ...
        if (!formData.commercialType) {
          newErrors.commercialType = "Please select a commercial type";
          isValid = false;
        }
        ...
        if (!formData.propertyCity.trim()) {
          ...
          newErrors.propertyCity = "Only letters and spaces allowed";
          isValid = false;
        }
      ...
      case 9: // Declaration
        ...
        if (!formData.signaturePlace.trim()) {
          ...
          newErrors.signaturePlace = "Only letters and spaces allowed";
          isValid = false;
        }
        break;
    }
  ...
  const handleSubmit = () => {
    if (validateStep(step)) {
      ...
      console.log("Sell PM Commercial Form submitted:", formData);
      onClose();
    }
  };
      ...
      <div className="fixed inset-0 z-50 flex flex-col sm:hidden">
        ...
        <div className="flex-1 bg-white rounded-3xl flex flex-col overflow-hidden shadow-2xl mx-5 mb-5">
          <div className="relative flex flex-col items-center justify-center px-4 pt-3 pb-3 overflow-hidden shrink-0 rounded-t-3xl"
            ...
            <h1 className="text-[13px] font-extrabold text-white tracking-wide relative z-10 text-center">Sell Commercial - Property Management</h1>
      ...
      <div className="fixed inset-0 bg-black/60 z-50 hidden sm:flex items-center justify-center p-4">
        <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl flex flex-col max-h-[90vh]">
          <div className="relative flex flex-col items-center justify-center min-h-[65px] px-4 pt-2.5 pb-2.5 overflow-hidden shrink-0 rounded-3xl"
            ...
            <button onClick={onClose} className="absolute top-2 right-2 w-7 h-7 rounded-full bg-white/25 hover:bg-white/40 flex items-center justify-center z-10 text-white font-bold text-[11px]">✕</button>
            <div className="text-xl mb-0.5 relative z-10">🏢</div>
            <h1 className="text-[14px] font-extrabold text-white tracking-wide relative z-10">Sell Commercial - Property Management</h1>
...
// MOBILE CONTENT - Sell PM Commercial
function MobContentSellPMCom({
  ...
  if (step === 0) return (
    <>
      <Field label="Property Management Company Name" required error={errors.pmCompanyName}>
        <input className={`${inp} ${getErrorClass('pmCompanyName')}`} placeholder="Enter company name" value={formData.pmCompanyName} onChange={(e) => handleAlphaNumericChange("pmCompanyName", e.target.value)} />
      </Field>
      <Field label="Business Registration Number" required error={errors.pmBusinessRegNumber}>
        <input className={`${inp} ${getErrorClass('pmBusinessRegNumber')}`} placeholder="Enter registration number" value={formData.pmBusinessRegNumber} onChange={(e) => handleAlphaNumericChange("pmBusinessRegNumber", e.target.value)} />
      </Field>
      <Field label="RERA Registration Number (If Applicable)">
        <input className={inp} placeholder="Enter RERA number" value={formData.pmReraNumber} onChange={(e) => handleAlphaNumericChange("pmReraNumber", e.target.value)} />
      </Field>
      <Field label="GST Number (Optional)">
        <input className={inp} placeholder="Enter GST number" value={formData.pmGstNumber} onChange={(e) => handleAlphaNumericChange("pmGstNumber", e.target.value)} />
      </Field>
      ...
      <Field label="Company Logo" required error={errors.pmCompanyLogo}>
        <div className={`border-2 border-dashed ${errors.pmCompanyLogo ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".jpg,.jpeg,.png" className="hidden" id="m-pm-logo-sell-com" onChange={(e) => handleDocumentUpload("pmCompanyLogo", e, 2)} />
          <label htmlFor="m-pm-logo-sell-com" className="cursor-pointer flex flex-col items-center">
  ...
  if (step === 1) return (
    <>
      ...
      <Field label="Full Name" required error={errors.authFullName}>
        <input className={`${inp} ${getErrorClass('authFullName')}`} placeholder="Enter authorized representative's full name" value={formData.authFullName} onChange={(e) => handleAlphaChange("authFullName", e.target.value)} />
      </Field>
      <Field label="Designation" required error={errors.authDesignation}>
        <input className={`${inp} ${getErrorClass('authDesignation')}`} placeholder="e.g. Director, Manager" value={formData.authDesignation} onChange={(e) => handleAlphaChange("authDesignation", e.target.value)} />
      </Field>
      <Field label="Mobile Number" required error={errors.authMobile}>
        <input className={`${inp} ${getErrorClass('authMobile')}`} type="tel" placeholder="Enter 10-digit mobile number" value={formData.authMobile} onChange={(e) => handleNumericChange("authMobile", e.target.value)} maxLength="10" />
      </Field>
      ...
      <Field label="WhatsApp Number">
        <input className={inp} type="tel" placeholder="Enter WhatsApp number" value={formData.authWhatsapp} onChange={(e) => handleNumericChange("authWhatsapp", e.target.value)} maxLength="10" />
      </Field>
      <Field label="Profile Photo" required error={errors.authPhoto}>
        <div className={`border-2 border-dashed ${errors.authPhoto ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".jpg,.jpeg,.png" className="hidden" id="m-authphoto-sell-com" onChange={(e) => handleDocumentUpload("authPhoto", e)} />
          <label htmlFor="m-authphoto-sell-com" className="cursor-pointer flex flex-col items-center">
  ...
  if (step === 2) return (
    <>
      ...
      <Field label="City" required error={errors.officeCity}>
        <input className={`${inp} ${getErrorClass('officeCity')}`} placeholder="Enter city" value={formData.officeCity} onChange={(e) => handleAlphaChange("officeCity", e.target.value)} />
      </Field>
      <Field label="District" required error={errors.officeDistrict}>
        <input className={`${inp} ${getErrorClass('officeDistrict')}`} placeholder="Enter district" value={formData.officeDistrict} onChange={(e) => handleAlphaChange("officeDistrict", e.target.value)} />
      </Field>
      <Field label="State" required error={errors.officeState}>
        <input className={`${inp} ${getErrorClass('officeState')}`} placeholder="Enter state" value={formData.officeState} onChange={(e) => handleAlphaChange("officeState", e.target.value)} />
      </Field>
      <Field label="PIN Code" required error={errors.officePinCode}>
        <input className={`${inp} ${getErrorClass('officePinCode')}`} type="tel" placeholder="Enter 6-digit PIN code" value={formData.officePinCode} onChange={(e) => handleNumericChange("officePinCode", e.target.value)} maxLength="6" />
      </Field>
  ...
  if (step === 3) return (
    <>
      ...
      <Field label="Aadhaar Number" required error={errors.aadhaarNumber}>
        <input className={`${inp} ${getErrorClass('aadhaarNumber')}`} type="tel" placeholder="Enter 12-digit Aadhaar number" value={formData.aadhaarNumber} onChange={(e) => handleNumericChange("aadhaarNumber", e.target.value)} maxLength="12" />
      </Field>
      <Field label="PAN Number" required error={errors.panNumber}>
        <input className={`${inp} ${getErrorClass('panNumber')}`} placeholder="Enter 10-character PAN number" value={formData.panNumber} onChange={(e) => updateForm("panNumber", e.target.value.toUpperCase())} maxLength="10" />
      </Field>
      ...
      <Field label="Upload Aadhaar Card" required error={errors.aadhaarCard}>
        <div className={`border-2 border-dashed ${errors.aadhaarCard ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-aadhaar-sell-com" onChange={(e) => handleDocumentUpload("aadhaarCard", e)} />
      ...
      <Field label="Upload PAN Card" required error={errors.panCard}>
        <div className={`border-2 border-dashed ${errors.panCard ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-pan-sell-com" onChange={(e) => handleDocumentUpload("panCard", e)} />
      ...
      <Field label="Upload Business Registration Certificate" required error={errors.pmBusinessRegCert}>
        <div className={`border-2 border-dashed ${errors.pmBusinessRegCert ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-pm-reg-sell-com" onChange={(e) => handleDocumentUpload("pmBusinessRegCert", e)} />
          <label htmlFor="m-pm-reg-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-6 h-6 text-[#00695C]" />
      ...
      <Field label="Upload GST Certificate (Optional)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="m-pm-gst-sell-com" onChange={(e) => handleDocumentUpload("pmGstCert", e)} />
          <label htmlFor="m-pm-gst-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-6 h-6 text-[#00695C]" />
      ...
      <Field label="Upload RERA Certificate (Optional)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="m-pm-rera-sell-com" onChange={(e) => handleDocumentUpload("pmReraCert", e)} />
          <label htmlFor="m-pm-rera-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-6 h-6 text-[#00695C]" />
      ...
      <Field label="Upload Office Address Proof" required error={errors.officeAddressProof}>
        <div className={`border-2 border-dashed ${errors.officeAddressProof ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-office-proof-sell-com" onChange={(e) => handleDocumentUpload("officeAddressProof", e)} />
          <label htmlFor="m-office-proof-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-6 h-6 text-[#00695C]" />
  ...
  if (step === 4) return (
    <>
        ...
        <div className="grid grid-cols-2 gap-1">
          {commercialTypeOptions.map(type => (
            <label key={type} className="flex items-center gap-1 text-[10px] cursor-pointer">
              <input type="radio" name="mob-com-type-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.commercialType === type} onChange={() => updateForm("commercialType", type)} />
              {type}
            </label>
          ))}
        </div>
      ...
      <Field label="Property City" required error={errors.propertyCity}>
        <input className={`${inp} ${getErrorClass('propertyCity')}`} placeholder="Enter property city name" value={formData.propertyCity} onChange={(e) => handleAlphaChange("propertyCity", e.target.value)} />
      </Field>
      ...
      <Field label="Furnishing Status">
        <div className="grid grid-cols-2 gap-1">
          {furnishingOptions.map(f => (
            <label key={f} className="flex items-center gap-1 text-[10px] cursor-pointer">
              <input type="radio" name="mob-furnish-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.furnishing === f} onChange={() => updateForm("furnishing", f)} />
              {f}
            </label>
          ))}
        </div>
      ...
      <Field label="Business Type Suitable" required error={errors.businessType}>
        <div className="grid grid-cols-2 gap-1">
          {businessTypeOptions.map(type => (
            <label key={type} className="flex items-center gap-1 text-[10px] cursor-pointer">
              <input type="radio" name="mob-biz-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.businessType === type} onChange={() => updateForm("businessType", type)} />
              {type}
            </label>
          ))}
        </div>
      ...
      <Field label="Ownership Type">
        <div className="flex gap-4">
          <label className="flex items-center gap-1.5 text-[11px] cursor-pointer">
            <input type="radio" name="mob-ownership-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.ownershipType === "Freehold"} onChange={() => updateForm("ownershipType", "Freehold")} />
            Freehold
          </label>
          <label className="flex items-center gap-1.5 text-[11px] cursor-pointer">
            <input type="radio" name="mob-ownership-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.ownershipType === "Leasehold"} onChange={() => updateForm("ownershipType", "Leasehold")} />
            Leasehold
          </label>
        </div>
      </Field>
        ...
        <div className="flex gap-4">
          {["New", "Good", "Renovated", "Needs Renovation"].map(condition => (
            <label key={condition} className="flex items-center gap-1.5 text-[11px] cursor-pointer">
              <input type="radio" name="mob-condition-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.propertyCondition === condition} onChange={() => updateForm("propertyCondition", condition)} />
              {condition}
            </label>
          ))}
        </div>
        ...
        <div className="flex gap-4">
          {["Commercial", "Industrial", "Mixed-Use"].map(zoning => (
            <label key={zoning} className="flex items-center gap-1.5 text-[11px] cursor-pointer">
              <input type="radio" name="mob-zoning-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.zoningType === zoning} onChange={() => updateForm("zoningType", zoning)} />
              {zoning}
            </label>
          ))}
        </div>
    ...
    <>
      ...
      <Field label="Immediate Possession">
        <div className="flex gap-4">
          {yesNoOptions.map(opt => (
            <label key={opt} className="flex items-center gap-1.5 text-[11px] cursor-pointer">
              <input type="radio" name="mob-possession-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.immediatePossession === opt} onChange={() => updateForm("immediatePossession", opt)} />
              {opt}
            </label>
          ))}
        </div>
  ...
  if (step === 6) return (
    <>
      ...
      <Field label="Account Holder Name" required error={errors.accountHolderName}>
        <input className={`${inp} ${getErrorClass('accountHolderName')}`} placeholder="Enter account holder name" value={formData.accountHolderName} onChange={(e) => handleAlphaChange("accountHolderName", e.target.value)} />
      </Field>
      ...
      <Field label="Account Number" required error={errors.accountNumber}>
        <input className={`${inp} ${getErrorClass('accountNumber')}`} type="tel" placeholder="Enter account number (9-18 digits)" value={formData.accountNumber} onChange={(e) => handleNumericChange("accountNumber", e.target.value)} maxLength="18" />
      </Field>
      <Field label="IFSC Code" required error={errors.ifscCode}>
        <input className={`${inp} ${getErrorClass('ifscCode')}`} placeholder="Enter IFSC code (e.g. SBIN0123456)" value={formData.ifscCode} onChange={(e) => updateForm("ifscCode", e.target.value.toUpperCase())} maxLength="11" />
      </Field>
      <Field label="UPI ID">
  ...
  if (step === 8) return (
    <>
      ...
      <Field label="Company Logo" required>
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept=".jpg,.jpeg,.png" className="hidden" id="m-pm-logo-doc-sell-com" onChange={(e) => handleDocumentUpload("pmCompanyLogoDoc", e, 2)} />
          <label htmlFor="m-pm-logo-doc-sell-com" className="cursor-pointer flex flex-col items-center">
            <ImagePlus className="w-5 h-5 text-[#00695C]" />
            <span className="text-[10px] font-semibold text-[#00695C]">Upload Logo</span>
            <span className="text-[9px] text-gray-400">JPG/PNG (Max 2MB)</span>
          </label>
      ...
      <Field label="Company Profile/Brochure (Optional)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="m-pm-brochure-sell-com" onChange={(e) => handleDocumentUpload("pmCompanyBrochure", e)} />
          <label htmlFor="m-pm-brochure-sell-com" className="cursor-pointer flex flex-col items-center">
      ...
      <Field label="Upload Floor Plan" required hint="PDF only (Max 5MB)" error={errors.floorPlan}>
        <div className={`border-2 border-dashed ${errors.floorPlan ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-floorplan-sell-pm-com" onChange={handleFloorPlanUpload} />
          <label htmlFor="m-floorplan-sell-pm-com" className="cursor-pointer flex flex-col items-center">
      ...
      <Field label="Sale Deed" required error={errors.saleDeed}>
        <div className={`border-2 border-dashed ${errors.saleDeed ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-saleDeed-sell-pm-com" onChange={(e) => handleDocumentUpload("saleDeed", e)} />
          <label htmlFor="m-saleDeed-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-5 h-5 text-[#00695C]" />
      ...
      <Field label="Encumbrance Certificate (EC)" required error={errors.encumbranceCertificate}>
        <div className={`border-2 border-dashed ${errors.encumbranceCertificate ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-ec-sell-pm-com" onChange={(e) => handleDocumentUpload("encumbranceCertificate", e)} />
          <label htmlFor="m-ec-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-5 h-5 text-[#00695C]" />
      ...
      <Field label="Property Tax Receipt">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="m-tax-sell-pm-com" onChange={(e) => handleDocumentUpload("propertyTaxReceipt", e)} />
          <label htmlFor="m-tax-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-5 h-5 text-[#00695C]" />
      ...
      <Field label="Building Approval Plan" required error={errors.buildingApprovalPlan}>
        <div className={`border-2 border-dashed ${errors.buildingApprovalPlan ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-building-sell-pm-com" onChange={(e) => handleDocumentUpload("buildingApprovalPlan", e)} />
          <label htmlFor="m-building-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-5 h-5 text-[#00695C]" />
      ...
      <Field label="Occupancy Certificate" required error={errors.occupancyCertificate}>
        <div className={`border-2 border-dashed ${errors.occupancyCertificate ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-occupancy-sell-pm-com" onChange={(e) => handleDocumentUpload("occupancyCertificate", e)} />
          <label htmlFor="m-occupancy-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-5 h-5 text-[#00695C]" />
      ...
      <Field label="Trade License" required error={errors.tradeLicense}>
        <div className={`border-2 border-dashed ${errors.tradeLicense ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-trade-sell-pm-com" onChange={(e) => handleDocumentUpload("tradeLicense", e)} />
          <label htmlFor="m-trade-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-5 h-5 text-[#00695C]" />
      ...
      <Field label="Fire Safety Certificate" required error={errors.fireSafetyCertificate}>
        <div className={`border-2 border-dashed ${errors.fireSafetyCertificate ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-fire-sell-pm-com" onChange={(e) => handleDocumentUpload("fireSafetyCertificate", e)} />
          <label htmlFor="m-fire-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-5 h-5 text-[#00695C]" />
      ...
      <Field label="Upload Cover Image" required hint="Max 2MB" error={errors.coverImage}>
        <div className={`border-2 border-dashed ${errors.coverImage ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept="image/*" className="hidden" id="m-cover-sell-pm-com" onChange={handleCoverImageUpload} />
          <label htmlFor="m-cover-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <ImagePlus className="w-5 h-5 text-[#00695C]" />
      ...
      <Field label="Upload Property Photos (Max 3)" required hint={`${formData.propertyImages.length}/3 images uploaded`} error={errors.propertyImages}>
        <div className={`border-2 border-dashed ${errors.propertyImages ? 'border-red-400' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept="image/*" multiple className="hidden" id="m-imgs-sell-pm-com" onChange={handleImageUpload} disabled={formData.propertyImages.length >= 3} />
          <label htmlFor="m-imgs-sell-pm-com" className={`cursor-pointer flex flex-col items-center ${formData.propertyImages.length >= 3 ? 'opacity-50 cursor-not-allowed' : ''}`}>
            <ImagePlus className="w-5 h-5 text-[#00695C]" />
      ...
      <Field label="Upload Property Video (Optional)" hint="Max 10MB">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept="video/mp4,video/mov" className="hidden" id="m-vid-sell-pm-com" onChange={handleVideoUpload} />
          <label htmlFor="m-vid-sell-pm-com" className="cursor-pointer flex flex-col items-center">
  ...
  if (step === 9) return (
    <>
      ...
      <Field label="Place" required error={errors.signaturePlace}>
        <input className={`${inp} ${errors.signaturePlace ? errorBorder : ''}`} placeholder="Enter place" value={formData.signaturePlace} onChange={(e) => handleAlphaChange("signaturePlace", e.target.value)} />
      </Field>
...
// DESKTOP CONTENT - Sell PM Commercial
function DtContentSellPMCom({
  step, inp, errorBorder, formData, updateForm, errors,
  imagePreviews, handleImageUpload, removeImage,
  handleVideoUpload, videoPreview, removeVideo,
  handleDocumentUpload,
    ...
    <>
      ...
      <FieldDt label="Company Logo" required error={errors.pmCompanyLogo}>
        <div className={`border-2 border-dashed ${errors.pmCompanyLogo ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".jpg,.jpeg,.png" className="hidden" id="dt-pm-logo-sell-com" onChange={(e) => handleDocumentUpload("pmCompanyLogo", e, 2)} />
          <label htmlFor="dt-pm-logo-sell-com" className="cursor-pointer flex flex-col items-center">
    ...
    <>
      ...
      <FieldDt label="Profile Photo" required error={errors.authPhoto}>
        <div className={`border-2 border-dashed ${errors.authPhoto ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".jpg,.jpeg,.png" className="hidden" id="dt-authphoto-sell-com" onChange={(e) => handleDocumentUpload("authPhoto", e)} />
          <label htmlFor="dt-authphoto-sell-com" className="cursor-pointer flex flex-col items-center">
    ...
    <>
      ...
      <FieldDt label="Upload Aadhaar Card" required error={errors.aadhaarCard}>
        <div className={`border-2 border-dashed ${errors.aadhaarCard ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-aadhaar-sell-com" onChange={(e) => handleDocumentUpload("aadhaarCard", e)} />
      ...
      <FieldDt label="Upload PAN Card" required error={errors.panCard}>
        <div className={`border-2 border-dashed ${errors.panCard ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-pan-sell-com" onChange={(e) => handleDocumentUpload("panCard", e)} />
      ...
      <FieldDt label="Upload Business Registration Certificate" required error={errors.pmBusinessRegCert}>
        <div className={`border-2 border-dashed ${errors.pmBusinessRegCert ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-pm-reg-sell-com" onChange={(e) => handleDocumentUpload("pmBusinessRegCert", e)} />
          <label htmlFor="dt-pm-reg-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload GST Certificate (Optional)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="dt-pm-gst-sell-com" onChange={(e) => handleDocumentUpload("pmGstCert", e)} />
          <label htmlFor="dt-pm-gst-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload RERA Certificate (Optional)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="dt-pm-rera-sell-com" onChange={(e) => handleDocumentUpload("pmReraCert", e)} />
          <label htmlFor="dt-pm-rera-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload Office Address Proof" required error={errors.officeAddressProof}>
        <div className={`border-2 border-dashed ${errors.officeAddressProof ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-office-proof-sell-com" onChange={(e) => handleDocumentUpload("officeAddressProof", e)} />
          <label htmlFor="dt-office-proof-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
    ...
    <>
        ...
        <div className="grid grid-cols-2 gap-2">
          {commercialTypeOptions.map(type => (
            <label key={type} className="flex items-center gap-2 text-[13px] cursor-pointer">
              <input type="radio" name="dt-com-type-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.commercialType === type} onChange={() => updateForm("commercialType", type)} />
              {type}
            </label>
          ))}
        </div>
      ...
      <FieldDt label="Furnishing Status">
        <div className="flex flex-wrap gap-3">
          {furnishingOptions.map(f => (
            <label key={f} className="flex items-center gap-2 text-[13px] cursor-pointer">
              <input type="radio" name="dt-furnish-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.furnishing === f} onChange={() => updateForm("furnishing", f)} />
              {f}
            </label>
          ))}
        </div>
      ...
      <FieldDt label="Business Type Suitable" required error={errors.businessType}>
        <div className="flex flex-wrap gap-3">
          {businessTypeOptions.map(type => (
            <label key={type} className="flex items-center gap-2 text-[13px] cursor-pointer">
              <input type="radio" name="dt-biz-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.businessType === type} onChange={() => updateForm("businessType", type)} />
              {type}
            </label>
          ))}
        </div>
      ...
      <FieldDt label="Ownership Type">
        <div className="flex gap-5">
          <label className="flex items-center gap-2 text-[13px] cursor-pointer">
            <input type="radio" name="dt-ownership-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.ownershipType === "Freehold"} onChange={() => updateForm("ownershipType", "Freehold")} />
            Freehold
          </label>
          <label className="flex items-center gap-2 text-[13px] cursor-pointer">
            <input type="radio" name="dt-ownership-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.ownershipType === "Leasehold"} onChange={() => updateForm("ownershipType", "Leasehold")} />
            Leasehold
          </label>
        </div>
      </FieldDt>
        ...
        <div className="flex flex-wrap gap-3">
          {["New", "Good", "Renovated", "Needs Renovation"].map(condition => (
            <label key={condition} className="flex items-center gap-2 text-[13px] cursor-pointer">
              <input type="radio" name="dt-condition-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.propertyCondition === condition} onChange={() => updateForm("propertyCondition", condition)} />
              {condition}
            </label>
          ))}
        </div>
        ...
        <div className="flex flex-wrap gap-3">
          {["Commercial", "Industrial", "Mixed-Use"].map(zoning => (
            <label key={zoning} className="flex items-center gap-2 text-[13px] cursor-pointer">
              <input type="radio" name="dt-zoning-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.zoningType === zoning} onChange={() => updateForm("zoningType", zoning)} />
              {zoning}
            </label>
          ))}
        </div>
    ...
    <>
      ...
      <FieldDt label="Immediate Possession">
        <div className="flex gap-5">
          {yesNoOptions.map(opt => (
            <label key={opt} className="flex items-center gap-2 text-[13px] cursor-pointer">
              <input type="radio" name="dt-possession-sell-pm" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.immediatePossession === opt} onChange={() => updateForm("immediatePossession", opt)} />
              {opt}
            </label>
          ))}
        </div>
  ...
  if (step === 8) return (
    <>
      ...
      <FieldDt label="Company Logo" required>
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept=".jpg,.jpeg,.png" className="hidden" id="dt-pm-logo-doc-sell-com" onChange={(e) => handleDocumentUpload("pmCompanyLogoDoc", e, 2)} />
          <label htmlFor="dt-pm-logo-doc-sell-com" className="cursor-pointer flex flex-col items-center">
            <ImagePlus className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Company Profile/Brochure (Optional)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="dt-pm-brochure-sell-com" onChange={(e) => handleDocumentUpload("pmCompanyBrochure", e)} />
          <label htmlFor="dt-pm-brochure-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload Floor Plan" required hint="PDF only (Max 5MB)" error={errors.floorPlan}>
        <div className={`border-2 border-dashed ${errors.floorPlan ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-floorplan-sell-pm-com" onChange={handleFloorPlanUpload} />
          <label htmlFor="dt-floorplan-sell-pm-com" className="cursor-pointer flex flex-col items-center">
      ...
      <FieldDt label="Sale Deed" required error={errors.saleDeed}>
        <div className={`border-2 border-dashed ${errors.saleDeed ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-saleDeed-sell-pm-com" onChange={(e) => handleDocumentUpload("saleDeed", e)} />
          <label htmlFor="dt-saleDeed-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Encumbrance Certificate (EC)" required error={errors.encumbranceCertificate}>
        <div className={`border-2 border-dashed ${errors.encumbranceCertificate ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-ec-sell-pm-com" onChange={(e) => handleDocumentUpload("encumbranceCertificate", e)} />
          <label htmlFor="dt-ec-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Property Tax Receipt">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="dt-tax-sell-pm-com" onChange={(e) => handleDocumentUpload("propertyTaxReceipt", e)} />
          <label htmlFor="dt-tax-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Building Approval Plan" required error={errors.buildingApprovalPlan}>
        <div className={`border-2 border-dashed ${errors.buildingApprovalPlan ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-building-sell-pm-com" onChange={(e) => handleDocumentUpload("buildingApprovalPlan", e)} />
          <label htmlFor="dt-building-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Occupancy Certificate" required error={errors.occupancyCertificate}>
        <div className={`border-2 border-dashed ${errors.occupancyCertificate ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-occupancy-sell-pm-com" onChange={(e) => handleDocumentUpload("occupancyCertificate", e)} />
          <label htmlFor="dt-occupancy-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Trade License" required error={errors.tradeLicense}>
        <div className={`border-2 border-dashed ${errors.tradeLicense ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-trade-sell-pm-com" onChange={(e) => handleDocumentUpload("tradeLicense", e)} />
          <label htmlFor="dt-trade-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Fire Safety Certificate" required error={errors.fireSafetyCertificate}>
        <div className={`border-2 border-dashed ${errors.fireSafetyCertificate ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-fire-sell-pm-com" onChange={(e) => handleDocumentUpload("fireSafetyCertificate", e)} />
          <label htmlFor="dt-fire-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload Cover Image" required hint="Max 2MB" error={errors.coverImage}>
        <div className={`border-2 border-dashed ${errors.coverImage ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept="image/*" className="hidden" id="dt-cover-sell-pm-com" onChange={handleCoverImageUpload} />
          <label htmlFor="dt-cover-sell-pm-com" className="cursor-pointer flex flex-col items-center">
            <ImagePlus className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload Property Photos (Max 3)" required hint={`${formData.propertyImages.length}/3 images uploaded`} error={errors.propertyImages}>
        <div className={`border-2 border-dashed ${errors.propertyImages ? 'border-red-400' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept="image/*" multiple className="hidden" id="dt-imgs-sell-pm-com" onChange={handleImageUpload} disabled={formData.propertyImages.length >= 3} />
          <label htmlFor="dt-imgs-sell-pm-com" className={`cursor-pointer flex flex-col items-center ${formData.propertyImages.length >= 3 ? 'opacity-50 cursor-not-allowed' : ''}`}>
            <ImagePlus className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload Property Video (Optional)" hint="Max 10MB">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept="video/mp4,video/mov" className="hidden" id="dt-vid-sell-pm-com" onChange={handleVideoUpload} />
          <label htmlFor="dt-vid-sell-pm-com" className="cursor-pointer flex flex-col items-center">
