  ...
  const validateStep = (stepIndex) => {
    ...
    switch(stepIndex) {
      ...
      case 5: // Pricing & Amenities
        const priceValidation = validateField(formData.sellPrice, { required: true, min: 0 });
        if (!priceValidation.valid) { newErrors.sellPrice = priceValidation.message; isValid = false; }
        break;
