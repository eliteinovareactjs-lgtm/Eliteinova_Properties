...
function MobContentSellBuilderApart({ 
  ...
  bankOptions, priceNegotiableOptions 
}) {
  ...
  if (step === 5) return (
    <>
      ...
      <Field label="Selling Price (₹)" required error={errors.sellPrice}>
        <input className={inp} type="number" min="0" placeholder="Enter selling price" value={formData.sellPrice} onChange={(e) => handleNumericFieldChange(e, updateForm, "sellPrice")} />
      </Field>
      ...
      <Field label="Maintenance Charges (₹/month)" hint="If applicable">
        <input className={inp} type="number" min="0" placeholder="Enter monthly maintenance amount" value={formData.maintenanceCharges} onChange={(e) => handleNumericFieldChange(e, updateForm, "maintenanceCharges")} />
      </Field>
      <Field label="Property Tax (₹/year)" hint="If applicable">
        <input className={inp} type="number" min="0" placeholder="Enter annual property tax" value={formData.propertyTax} onChange={(e) => handleNumericFieldChange(e, updateForm, "propertyTax")} />
      </Field>
...
function DtContentSellBuilderApart({ 
  step, inp, formData, updateForm, 
  handleAlphaFieldChange, handleNumericFieldChange, handleAlphaNumericFieldChange,
  errors, imagePreviews, handleImageUpload, removeImage, 
  handleVideoUpload, videoPreview, removeVideo, 
