...
const zoningTypeOptions = ["Commercial", "Industrial", "Mixed-Use"];

export default function SellBuilderComForm({ isOpen, onClose }) {
  ...
  const validateStep = (stepNumber) => {
    ...
    switch(stepNumber) {
      ...
      case 1: // Authorized Person
        ...
        if (!formData.authMobile || !/^[0-9]{10}$/.test(formData.authMobile)) {
          newErrors.authMobile = "Please enter a valid 10-digit mobile number";
          isValid = false;
        }
        
        if (!formData.authEmail || !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.authEmail)) {
      ...
      case 5: // Pricing & Amenities
        if (!formData.sellPrice || parseFloat(formData.sellPrice) <= 0) {
          ...
          isValid = false;
        } else if (!/^\d+(\.\d+)?$/.test(formData.sellPrice)) {
          newErrors.sellPrice = "Enter a valid number";
          isValid = false;
        }
      ...
      case 9: // Declaration
        ...
        if (!formData.declarationCompliance) {
          newErrors.declarationCompliance = "You must accept this declaration";
          isValid = false;
        }
  ...
  const handleSubmit = () => {
    if (validateStep(step)) {
      ...
      console.log("Sell Builder Commercial Form submitted:", formData);
      onClose();
    }
  };
      ...
      <div className="fixed inset-0 z-50 flex flex-col sm:hidden">
        ...
        <div className="flex-1 bg-white rounded-3xl flex flex-col overflow-hidden shadow-2xl mx-5 mb-5">
          <div className="relative flex flex-col items-center justify-center px-4 pt-3 pb-3 overflow-hidden shrink-0 rounded-t-3xl"
            ...
            <h1 className="text-[13px] font-extrabold text-white tracking-wide relative z-10 text-center">Sell Commercial - Builder/Company</h1>
      ...
      <div className="fixed inset-0 bg-black/60 z-50 hidden sm:flex items-center justify-center p-4">
        <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl flex flex-col max-h-[90vh]">
          <div className="relative flex flex-col items-center justify-center min-h-[65px] px-4 pt-2.5 pb-2.5 overflow-hidden shrink-0 rounded-3xl"
            ...
            <button onClick={onClose} className="absolute top-2 right-2 w-7 h-7 rounded-full bg-white/25 hover:bg-white/40 flex items-center justify-center z-10 text-white font-bold text-[11px]">✕</button>
            <div className="text-xl mb-0.5 relative z-10">🏗️</div>
            <h1 className="text-[14px] font-extrabold text-white tracking-wide relative z-10">Sell Commercial - Builder/Company</h1>
...
// MOBILE CONTENT - Sell Builder Commercial
function MobContentSellBuilderCom({ 
  ...
  bankOptions, serviceAreaOptions, nearbyPlaceOptions,
  ownershipTypeOptions, propertyConditionOptions, zoningTypeOptions
}) {
    ...
    <>
      ...
      <Field label="Profile Photo" required hint="JPG, PNG max 2MB" error={errors.authPhoto}>
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept="image/*" className="hidden" id="m-authphoto-sell-com" onChange={(e) => {
            const file = e.target.files[0];
            if (file) {
              if (file.size > 2 * 1024 * 1024) {
    ...
    <>
      ...
      <Field label="Upload Aadhaar Card" required error={errors.aadhaarCard}>
        <div className={`border-2 border-dashed ${errors.aadhaarCard ? 'border-red-500' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-authaadhaar-sell-com" onChange={(e) => handleDocumentUpload("aadhaarCard", e)} />
          <label htmlFor="m-authaadhaar-sell-com" className="cursor-pointer flex flex-col items-center">
      ...
      <Field label="Upload PAN Card" required error={errors.panCard}>
        <div className={`border-2 border-dashed ${errors.panCard ? 'border-red-500' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-authpan-sell-com" onChange={(e) => handleDocumentUpload("panCard", e)} />
          <label htmlFor="m-authpan-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-6 h-6 text-[#00695C]" />
      ...
      <Field label="Upload Company Registration Certificate" required error={errors.companyRegCert}>
        <div className={`border-2 border-dashed ${errors.companyRegCert ? 'border-red-500' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-companyreg-sell-com" onChange={(e) => handleDocumentUpload("companyRegCert", e)} />
          <label htmlFor="m-companyreg-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-6 h-6 text-[#00695C]" />
      ...
      <Field label="Upload GST Certificate (Optional)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="m-gstcert-sell-com" onChange={(e) => handleDocumentUpload("gstCert", e)} />
          <label htmlFor="m-gstcert-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-6 h-6 text-[#00695C]" />
      ...
      <Field label="Upload RERA Certificate" required error={errors.reraCert}>
        <div className={`border-2 border-dashed ${errors.reraCert ? 'border-red-500' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-reracert-sell-com" onChange={(e) => handleDocumentUpload("reraCert", e)} />
          <label htmlFor="m-reracert-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-6 h-6 text-[#00695C]" />
      ...
      <Field label="Upload Company PAN Card (Optional)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="m-companypan-sell-com" onChange={(e) => handleDocumentUpload("companyPanCard", e)} />
          <label htmlFor="m-companypan-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-6 h-6 text-[#00695C]" />
  ...
  // STEP 4: Property Details - Sell specific
  if (step === 4) return (
    <>
      <div className="flex items-center gap-1.5 mb-2 pb-1.5 border-b-2 border-green-50">
        <div className="w-1 h-3 bg-[#00695C] rounded" />
      ...
      <Field label="Property Title / Name" required error={errors.propertyTitle}>
        <input className={`${inp} ${errors.propertyTitle ? errorBorder : ''}`} placeholder="e.g. Prime Retail Space, Office Complex" value={formData.propertyTitle} onChange={(e) => updateForm("propertyTitle", e.target.value.replace(/[^a-zA-Z0-9\s]/g, ''))} />
      </Field>
      ...
      <Field label="Property Address" required error={errors.propertyAddress}>
        <textarea className={`${ta} min-h-[55px] ${errors.propertyAddress ? errorBorder : ''}`} placeholder="Enter complete property address" value={formData.propertyAddress} onChange={handleAddressChange("propertyAddress")} />
      </Field>
      <Field label="Property City" required error={errors.propertyCity}>
        <input className={`${inp} ${errors.propertyCity ? errorBorder : ''}`} placeholder="Enter property city name" value={formData.propertyCity} onChange={handleAlphaChange("propertyCity")} />
      </Field>
      ...
      <Field label="Service Area">
        <div className="flex flex-wrap gap-1">
          {serviceAreaOptions.map(option => (
            <label key={option} className="flex items-center gap-1 text-[10px] cursor-pointer">
              <input type="checkbox" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.serviceArea.includes(option)} onChange={() => toggleArrayItem("serviceArea", option)} />
              {option}
            </label>
          ))}
        </div>
      ...
      <Field label="Nearby Places">
        <div className="flex flex-wrap gap-1">
          {nearbyPlaceOptions.map(option => (
            <label key={option} className="flex items-center gap-1 text-[10px] cursor-pointer">
              <input type="checkbox" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.nearbyPlaces.includes(option)} onChange={() => toggleArrayItem("nearbyPlaces", option)} />
              {option}
            </label>
          ))}
        </div>
      ...
      <Field label="Nearby Connectivity">
        <input className={inp} placeholder="Enter nearby connectivity details" value={formData.nearbyConnectivity} onChange={(e) => updateForm("nearbyConnectivity", e.target.value)} />
      </Field>
  ...
  // STEP 5: Pricing & Amenities - Sell specific
  if (step === 5) return (
    <>
      <div className="flex items-center gap-1.5 mb-2 pb-1.5 border-b-2 border-green-50">
        <div className="w-1 h-3 bg-[#00695C] rounded" />
      ...
      <Field label="Selling Price (₹)" required error={errors.sellPrice}>
        <input className={`${inp} ${errors.sellPrice ? errorBorder : ''}`} type="text" inputMode="decimal" placeholder="Enter selling price" value={formData.sellPrice} onChange={(e) => updateForm("sellPrice", e.target.value.replace(/[^0-9.]/g, ''))} />
      </Field>
      <Field label="Budget Range (₹)" hint="Set a range for negotiation">
        <div className="flex gap-1">
          <input className={`${inp} w-1/2`} type="text" inputMode="decimal" placeholder="Min" value={formData.budgetRange.min} onChange={(e) => updateForm("budgetRange", { ...formData.budgetRange, min: e.target.value.replace(/[^0-9.]/g, '') })} />
          <input className={`${inp} w-1/2`} type="text" inputMode="decimal" placeholder="Max" value={formData.budgetRange.max} onChange={(e) => updateForm("budgetRange", { ...formData.budgetRange, max: e.target.value.replace(/[^0-9.]/g, '') })} />
        </div>
      </Field>
      <Field label="Price Type" required error={errors.priceType}>
        <div className="flex gap-4">
          <label className="flex items-center gap-1.5 text-[11px] cursor-pointer">
            <input type="radio" name="mob-priceType-sell" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.priceType === "fixed"} onChange={() => updateForm("priceType", "fixed")} />
            Fixed
          </label>
          <label className="flex items-center gap-1.5 text-[11px] cursor-pointer">
            <input type="radio" name="mob-priceType-sell" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.priceType === "negotiable"} onChange={() => updateForm("priceType", "negotiable")} />
            Negotiable
          </label>
        </div>
      </Field>
  ...
  // STEP 8: Documents - Sell specific
  if (step === 8) return (
    <>
      <div className="flex items-center gap-1.5 mb-2 pb-1.5 border-b-2 border-green-50">
        <div className="w-1 h-3 bg-[#00695C] rounded" />
      ...
      <Field label="Company Logo" required hint="JPG, PNG max 2MB" error={errors.companyLogoDoc}>
        <div className={`border-2 border-dashed ${errors.companyLogoDoc ? 'border-red-500' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept="image/*" className="hidden" id="m-comp-logo-sell-com" onChange={(e) => {
            const file = e.target.files[0];
            if (file) {
              if (file.size > 2 * 1024 * 1024) {
              ...
              if (errors.companyLogoDoc) {
                setErrors(prev => ({ ...prev, companyLogoDoc: null }));
              }
            }
          }} />
          <label htmlFor="m-comp-logo-sell-com" className="cursor-pointer flex flex-col items-center">
      ...
      <Field label="Company Profile Brochure (PDF)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="m-comp-brochure-sell-com" onChange={(e) => handleDocumentUpload("companyBrochure", e)} />
          <label htmlFor="m-comp-brochure-sell-com" className="cursor-pointer flex flex-col items-center">
      ...
      <Field label="Project Brochure(s)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-2.5 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" multiple className="hidden" id="m-project-brochures-sell-com" onChange={(e) => {
            const files = Array.from(e.target.files);
          ...
          <label htmlFor="m-project-brochures-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-5 h-5 text-[#00695C]" />
      ...
      <Field label="Authorized Signatory ID Proof" required error={errors.authIdProof}>
        <div className={`border-2 border-dashed ${errors.authIdProof ? 'border-red-500' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="m-auth-id-sell-com" onChange={(e) => handleDocumentUpload("authIdProof", e)} />
          <label htmlFor="m-auth-id-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-5 h-5 text-[#00695C]" />
      ...
      {/* Property Documents - Sell specific */}
      <div className="flex items-center gap-1.5 mt-3 mb-2 pb-1.5 border-b-2 border-green-50">
        <div className="w-1 h-3 bg-[#00695C] rounded" />
      ...
      <Field label="Sale Deed" required error={errors.saleDeed}>
        <div className={`border-2 border-dashed ${errors.saleDeed ? 'border-red-500' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
      ...
      <Field label="Trade License" required error={errors.tradeLicense}>
        <div className={`border-2 border-dashed ${errors.tradeLicense ? 'border-red-500' : 'border-teal-300'} rounded-xl p-2.5 text-center hover:bg-green-50`}>
...
// DESKTOP CONTENT - Sell Builder Commercial
function DtContentSellBuilderCom({ 
  step, inp, errorBorder, formData, errors, updateForm, 
  imagePreviews, handleImageUpload, removeImage,
  handleVideoUpload, videoPreview, removeVideo,
  handleDocumentUpload,
    ...
    <>
      ...
      <FieldDt label="Profile Photo" required hint="JPG, PNG max 2MB" error={errors.authPhoto}>
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept="image/*" className="hidden" id="dt-authphoto-sell-com" onChange={(e) => {
            const file = e.target.files[0];
            if (file) {
              if (file.size > 2 * 1024 * 1024) {
                alert("Profile photo must be less than 2MB");
    ...
    <>
      ...
      <FieldDt label="Upload Aadhaar Card" required error={errors.aadhaarCard}>
        <div className={`border-2 border-dashed ${errors.aadhaarCard ? 'border-red-500' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-authaadhaar-sell-com" onChange={(e) => handleDocumentUpload("aadhaarCard", e)} />
          <label htmlFor="dt-authaadhaar-sell-com" className="cursor-pointer flex flex-col items-center">
      ...
      <FieldDt label="Upload PAN Card" required error={errors.panCard}>
        <div className={`border-2 border-dashed ${errors.panCard ? 'border-red-500' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-authpan-sell-com" onChange={(e) => handleDocumentUpload("panCard", e)} />
          <label htmlFor="dt-authpan-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload Company Registration Certificate" required error={errors.companyRegCert}>
        <div className={`border-2 border-dashed ${errors.companyRegCert ? 'border-red-500' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-companyreg-sell-com" onChange={(e) => handleDocumentUpload("companyRegCert", e)} />
          <label htmlFor="dt-companyreg-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload GST Certificate (Optional)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="dt-gstcert-sell-com" onChange={(e) => handleDocumentUpload("gstCert", e)} />
          <label htmlFor="dt-gstcert-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload RERA Certificate" required error={errors.reraCert}>
        <div className={`border-2 border-dashed ${errors.reraCert ? 'border-red-500' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-reracert-sell-com" onChange={(e) => handleDocumentUpload("reraCert", e)} />
          <label htmlFor="dt-reracert-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Upload Company PAN Card (Optional)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="dt-companypan-sell-com" onChange={(e) => handleDocumentUpload("companyPanCard", e)} />
          <label htmlFor="dt-companypan-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
  ...
  // STEP 4: Property Details - Sell specific (Desktop)
  if (step === 4) return (
    <>
      <div className="flex items-center gap-2 mb-3 pb-2 border-b-2 border-green-50">
        <div className="w-1 h-4 bg-[#00695C] rounded" />
      ...
      <FieldDt label="Property Address" required error={errors.propertyAddress}>
        <textarea className={`${ta} min-h-[70px] ${errors.propertyAddress ? errorBorder : ''}`} placeholder="Enter complete property address" value={formData.propertyAddress} onChange={handleAddressChange("propertyAddress")} />
      </FieldDt>
  ...
  // STEP 5: Pricing & Amenities - Sell specific (Desktop)
  if (step === 5) return (
    <>
      <div className="flex items-center gap-2 mb-3 pb-2 border-b-2 border-green-50">
        <div className="w-1 h-4 bg-[#00695C] rounded" />
      ...
      <FieldDt label="Price Type" required error={errors.priceType}>
        <div className="flex gap-5">
          <label className="flex items-center gap-2 text-[13px] cursor-pointer">
            <input type="radio" name="dt-priceType-sell" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.priceType === "fixed"} onChange={() => updateForm("priceType", "fixed")} />
            Fixed Price
          </label>
          <label className="flex items-center gap-2 text-[13px] cursor-pointer">
            <input type="radio" name="dt-priceType-sell" className="accent-[#00695C] w-3.5 h-3.5 cursor-pointer" checked={formData.priceType === "negotiable"} onChange={() => updateForm("priceType", "negotiable")} />
            Negotiable
          </label>
        </div>
      </FieldDt>
  ...
  // STEP 8: Documents - Sell specific (Desktop)
  if (step === 8) return (
    <>
      <div className="flex items-center gap-2 mb-3 pb-2 border-b-2 border-green-50">
        <div className="w-1 h-4 bg-[#00695C] rounded" />
      ...
      <FieldDt label="Company Logo" required hint="JPG, PNG max 2MB" error={errors.companyLogoDoc}>
        <div className={`border-2 border-dashed ${errors.companyLogoDoc ? 'border-red-500' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept="image/*" className="hidden" id="dt-comp-logo-sell-com" onChange={(e) => {
            const file = e.target.files[0];
            if (file) {
              if (file.size > 2 * 1024 * 1024) {
                alert("Company logo must be less than 2MB");
          ...
          <label htmlFor="dt-comp-logo-sell-com" className="cursor-pointer flex flex-col items-center">
      ...
      <FieldDt label="Company Profile Brochure (PDF)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" className="hidden" id="dt-comp-brochure-sell-com" onChange={(e) => handleDocumentUpload("companyBrochure", e)} />
          <label htmlFor="dt-comp-brochure-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Project Brochure(s)">
        <div className="border-2 border-dashed border-teal-300 rounded-xl p-3 text-center hover:bg-green-50">
          <input type="file" accept=".pdf" multiple className="hidden" id="dt-project-brochures-sell-com" onChange={(e) => {
            const files = Array.from(e.target.files);
            const validFiles = files.filter(f => f.type === 'application/pdf');
            if (validFiles.length !== files.length) {
              alert('Only PDF files are allowed');
          ...
          <label htmlFor="dt-project-brochures-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Authorized Signatory ID Proof" required error={errors.authIdProof}>
        <div className={`border-2 border-dashed ${errors.authIdProof ? 'border-red-500' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
          <input type="file" accept=".pdf" className="hidden" id="dt-auth-id-sell-com" onChange={(e) => handleDocumentUpload("authIdProof", e)} />
          <label htmlFor="dt-auth-id-sell-com" className="cursor-pointer flex flex-col items-center">
            <FileText className="w-7 h-7 text-[#00695C]" />
      ...
      <FieldDt label="Sale Deed" required error={errors.saleDeed}>
        <div className={`border-2 border-dashed ${errors.saleDeed ? 'border-red-500' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
      ...
      <FieldDt label="Trade License" required error={errors.tradeLicense}>
        <div className={`border-2 border-dashed ${errors.tradeLicense ? 'border-red-500' : 'border-teal-300'} rounded-xl p-3 text-center hover:bg-green-50`}>
