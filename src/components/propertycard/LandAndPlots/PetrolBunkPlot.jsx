// PetrolBunkPlot.jsx (Property Card Component)
import React, { useState, useEffect } from 'react';
import { PetrolBunkPlotData } from "../../data/LandAndPlots/PetrolBunkPlotData";

const PAGE_NAME = "PetrolBunk";
...
const extractPropertyType = (highlights) => {
  ...
  const propertyTypes = ['Petrol Bunk', 'Fuel Station', 'CNG Station', 'Highway Petrol Pump', 'City Fuel Station', 'EV Charging Station', 'Petrol + CNG', 'Petrol + Diesel'];
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No Petrol Bunk Plot properties available at the moment.</p>
              </div>
            )}
          </div>
        </div>
