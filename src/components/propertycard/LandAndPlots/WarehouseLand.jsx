// WarehouseLand.jsx (Property Card Component)
import React, { useState, useEffect } from 'react';
import { WarehouseLandData } from "../../data/LandAndPlots/WarehouseLandData";
...
const extractPropertyType = (highlights) => {
  ...
  const propertyTypes = ['Warehouse', 'Logistics Hub', 'Distribution Center', 'Cold Storage', 'Godown', 'Storage Facility', 'Fulfillment Center', 'Warehousing Complex'];
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No Warehouse Land properties available at the moment.</p>
              </div>
            )}
          </div>
        </div>
