// ShoppingComplexLand.jsx (Property Card Component)
import React, { useState, useEffect } from 'react';
import { ShoppingComplexLandData } from "../../data/LandAndPlots/ShoppingComplexLandData";

const PAGE_NAME = "ShoppingComplex";
...
// Helper: extract complex type from highlights
const extractComplexType = (highlights) => {
  if (!highlights) return '';
  const complexTypes = ['Mall Development', 'Retail Complex', 'Community Shopping Center', 'Hypermarket', 'Entertainment Hub', 'Food Court Development'];
...
const PropertyCard = ({ property, onContactClick }) => {
  ...
  const complexType = extractComplexType(property.highlights);
              ...
              <div className="flex flex-wrap justify-between items-start gap-2">
                <div className="flex-1">
                  <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0">
                    ...
                    {complexType && <span className="font-bold text-[#00695C] text-base md:text-lg ml-1">({complexType})</span>}
                  </div>
            ...
            <div className="p-5">
              ...
              <div className="mb-4">
                ...
                <div className="bg-teal-50/50 rounded-xl p-4 space-y-2">
                  ...
                  <p className="text-sm"><strong>Listed Price:</strong> {property.price} {complexType && `(${complexType})`}</p>
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No Shopping Complex Land properties available at the moment.</p>
              </div>
            )}
          </div>
        </div>
