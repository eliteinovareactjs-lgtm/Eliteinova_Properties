// IndustrialCommercialPlot.jsx (Property Card Component)
import React, { useState, useEffect } from 'react';
import { IndustrialCommercialPlotData } from "../../data/LandAndPlots/IndustrialCommercialPlotData";

const PAGE_NAME = "IndComm";
...
const extractPropertyType = (highlights) => {
  ...
  const propertyTypes = ['Industrial Plot', 'Commercial Plot', 'Industrial Estate', 'Business Park', 'Manufacturing Hub', 'Logistics Park', 'Industrial Complex', 'Commercial Hub'];
            ...
            <div className="p-5">
              ...
              <div className="mb-4">
                ...
                <div className="bg-teal-50/50 rounded-xl p-4 space-y-2">
                  ...
                  <p className="text-sm"><strong>{property.sqftPrice}</strong> • 🟩 {property.totalSqft} • 🏭 {property.builtUp}</p>
                  <p
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No Industrial Commercial Plot properties available at the moment.</p>
              </div>
            )}
          </div>
        </div>
