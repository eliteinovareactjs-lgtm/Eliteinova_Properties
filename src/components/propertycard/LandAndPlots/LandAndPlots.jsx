...
import { LandAndPlotsData } from "../../data/LandAndPlots/LandAndPlotsData";

const PAGE_NAME = "LandAndPlots";
...
const extractPropertyType = (highlights) => {
  ...
  const propertyTypes = ['IT Park', 'Tech Park', 'Software Technology Park', 'SEZ IT Park', 'IT/ITES SEZ', 'Knowledge Park', 'Cyber Park', 'Technology Hub'];
...
const LandAndPlots = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(LandAndPlotsData);
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No IT Park Land properties available at the moment.</p>
              </div>
            )}
          </div>
        </div>
