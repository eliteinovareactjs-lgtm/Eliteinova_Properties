// ShowroomPlot.jsx (Property Card Component)
import React, { useState, useEffect } from 'react';
import { ShowroomPlotData } from "../../data/LandAndPlots/ShowroomPlotData";

const PAGE_NAME = "Showroom";
...
// Helper: extract showroom type from highlights
const extractShowroomType = (highlights) => {
  if (!highlights) return '';
  const showroomTypes = ['Automobile Showroom', 'Electronics Showroom', 'Furniture Showroom', 'Fashion Store', 'Mobile Store', 'Multi-brand Outlet', 'Luxury Product Center', 'Franchise Showroom'];
  for (const type of showroomTypes) {
...
const PropertyCard = ({ property, onContactClick }) => {
  ...
  const showroomType = extractShowroomType(property.highlights);
              ...
              <div className="flex flex-wrap justify-between items-start gap-2">
                <div className="flex-1">
                  <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0">
                    ...
                    {showroomType && <span className="font-bold text-[#00695C] text-base md:text-lg ml-1">({showroomType})</span>}
                  </div>
            ...
            <div className="p-5">
              ...
              <div className="mb-4">
                ...
                <div className="bg-teal-50/50 rounded-xl p-4 space-y-2">
                  ...
                  <p className="text-sm"><strong>Listed Price:</strong> {property.price} {showroomType && `(${showroomType})`}</p>
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No Showroom Plot properties available at the moment.</p>
              </div>
            )}
          </div>
        </div>
