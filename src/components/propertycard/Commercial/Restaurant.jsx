...
import { RestaurantData } from "../../data/Commercial/RestaurantData";

const PAGE_NAME = "Restaurant";
...
const Restaurant = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(RestaurantData);
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No Restaurant apartments available at the moment.</p>
              </div>
            )}
          </div>
        </div>
