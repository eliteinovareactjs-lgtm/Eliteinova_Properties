...
import { CommercialComplexData } from "../../data/Commercial/CommercialComplexData";

const PAGE_NAME = "Commercial Complex";
...
const CommercialComplex = () => {
  const [showLoginModal, setShowLoginModal] = useState(false);
  const [selectedProperty, setSelectedProperty] = useState(null);
  const [showContactInfo, setShowContactInfo] = useState(false);
  const [filteredProperties, setFilteredProperties] = useState(CommercialComplexData);
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No CommercialComplex apartments available at the moment.</p>
              </div>
            )}
          </div>
        </div>
...
export default CommercialComplex;