...
import { ColdStorageData } from "../../data/Commercial/ColdStorageData";

const PAGE_NAME = "Cold Storage";
...
const ColdStorage = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(ColdStorageData);
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No ColdStorage apartments available at the moment.</p>
              </div>
            )}
          </div>
        </div>
