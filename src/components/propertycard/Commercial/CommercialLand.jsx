...
import { CommercialLandData } from "../../data/Commercial/CommercialLandData";

const PAGE_NAME = "Commercial Land";
...
const CommercialLand = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(CommercialLandData);
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No CommercialLand apartments available at the moment.</p>
              </div>
            )}
          </div>
        </div>
