...
import { PetrolBunkData } from "../../data/Commercial/PetrolBunkData";

const PAGE_NAME = "Petrol Bunk";
...
const PetrolBunk = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(PetrolBunkData);
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No PetrolBunk apartments available at the moment.</p>
              </div>
            )}
          </div>
        </div>
