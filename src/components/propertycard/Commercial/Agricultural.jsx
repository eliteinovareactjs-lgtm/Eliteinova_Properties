...
import { AgriculturalData } from "../../data/Commercial/AgriculturalData";

const PAGE_NAME = "Agricultural";
...
const Agricultural = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(AgriculturalData);
          ...
          <div className="flex flex-col gap-5">
            {filteredProperties.length > 0 ? (
              ...
              <div className="w-full bg-white rounded-2xl shadow-2xl border border-teal-100 p-8 text-center">
                ...
                <p className="text-xs text-slate-500">No Agricultural apartments available at the moment.</p>
              </div>
            )}
          </div>
        </div>
