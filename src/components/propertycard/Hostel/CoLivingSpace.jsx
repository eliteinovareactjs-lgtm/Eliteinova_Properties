...
import { CoLivingSpaceData } from "../../data/Hostel/CoLivingSpaceData";

const PAGE_NAME = "CoLiving Space";
...
const CoLivingSpace = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(CoLivingSpaceData);
