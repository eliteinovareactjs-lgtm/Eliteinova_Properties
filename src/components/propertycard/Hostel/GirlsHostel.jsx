...
import { GirlsHostelData } from "../../data/Hostel/GirlsHostelData";

const PAGE_NAME = "Girls Hostel";
...
const GirlsHostel = () => {
  ...
  const [filteredProperties, setFilteredProperties] = useState(GirlsHostelData);
