...
import BoysHostel from "../../components/propertycard/Hostel/BoysHostel";
...
const BoysHostelPage = () => {
  ...
  const activeHostelType = "Boys Hostel";
  ...
  const handleFilterChange = (filters) => {
    ...
    // TODO: wire this into the actual listing query once the Boys Hostel
    // listings API/data source is available.
    console.log("Boys Hostel filters applied:", filters);
  };
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search boys hostels by city, locality, or landmark"
        ...
        <section className="w-full relative flex items-center justify-center group py-2 md:py-4">
          ...
          <div className="max-w-none mx-auto px-4 sm:px-6 relative z-10 text-center w-full flex flex-col items-center justify-center gap-2">
            ...
            <p className="text-sm md:text-base lg:text-lg text-white/90 max-w-3xl mx-auto leading-relaxed px-2">
              Discover safe, verified boys hostels with warden supervision near your college or workplace
            </p>
