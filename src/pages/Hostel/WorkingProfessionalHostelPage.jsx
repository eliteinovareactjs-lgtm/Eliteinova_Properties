// WorkingProfessionalHostelPage.jsx
import React, { useState, useEffect } from "react";
import { ChevronDown, Search, Home, MapPin, Star, Filter, X, Building, Landmark, Warehouse, Building2, Users, BedDouble, Briefcase, Hotel, LayoutGrid, Grid3X3, Crown, Castle, Building as BuildingIcon } from "lucide-react";
...
import WorkingProfessionalHostelFilter from "../../components/filters/Hostel/WorkingProfessionalHostelFilter";
import WorkingProfessionalHostel from "../../components/propertycard/Hostel/WorkingProfessionalHostel";

const WorkingProfessionalHostelPage = () => {
  ...
  const [activeHostelType, setActiveHostelType] = useState("Working Professional Hostel");
  ...
  const hostelCategories = [
    ...
    { name: "Working Professional Hostel", path: "/hostel/working-professional-hostel", icon: <Briefcase className="w-3.5 h-3.5" /> }
  ];
  ...
  useEffect(() => {
    ...
    if (currentPath === "/hostel/working-professional-hostel") {
      setActiveHostelType("Working Professional Hostel");
    }
  }, [location.pathname]);
  ...
  const handleFilterChange = (filters) => {
    ...
    console.log("Working Professional Hostel filters applied:", filters);
  };
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search working professional hostels by city, locality, or landmark"
            ...
            <div className="flex flex-row min-h-[170px] sm:min-h-[220px] md:min-h-[280px] lg:min-h-[330px]">
              ...
              <div className="flex flex-col justify-center w-[38%] sm:w-[37%] md:w-[36%] lg:w-[35%] shrink-0 px-2.5 sm:px-5 md:px-6 lg:px-10 py-2.5 sm:py-4 md:py-6 lg:py-7 z-20">
                ...
                <p className="mt-1 sm:mt-2 md:mt-2.5 lg:mt-3 max-w-[120px] sm:max-w-[200px] md:max-w-[280px] lg:max-w-[340px] text-[#31544E] text-[8px] sm:text-[10px] md:text-xs lg:text-sm leading-snug lg:leading-relaxed">
                  Discover premium hostels designed for working
                  professionals with modern amenities and
              ...
              <div className="relative overflow-hidden flex-1" style={{ aspectRatio: '16/8' }}>
                ...
                <img
                  src={bannerImg}
                  alt="Working Professional Hostel accommodation"
        ...
        {showFilterModal && (
          <div className="fixed inset-0 z-[9999] flex items-start justify-center pt-[140px] px-4 pb-4 bg-black/50 backdrop-blur-sm animate-fade-in lg:hidden">
            <div className="relative w-full max-w-2xl max-h-[80vh] overflow-y-auto">
              <WorkingProfessionalHostelFilter
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
            ...
            <div className="hidden lg:block lg:w-1/3 lg:relative">
              <div className="lg:sticky lg:top-[110px] lg:max-h-[calc(100vh-130px)] lg:overflow-y-auto lg:scrollbar-hide animate-slide-in-right">
                <WorkingProfessionalHostelFilter onFilterChange={handleFilterChange} />
              </div>
            </div>
...
export default WorkingProfessionalHostelPage;