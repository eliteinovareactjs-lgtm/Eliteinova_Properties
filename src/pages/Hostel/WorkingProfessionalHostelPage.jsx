...
import { ChevronDown, Search, Home, MapPin, Star, Filter, Building, Landmark, Warehouse, Building2, Users, BedDouble, Briefcase } from "lucide-react";
...
const WorkingProfessionalHostelPage = () => {
  ...
  const activeHostelType = "Working Professional Hostel";
        ...
        <section className="w-full relative flex items-center justify-center group py-2 md:py-4">
          ...
          <div className="max-w-none mx-auto px-4 sm:px-6 relative z-10 text-center w-full flex flex-col items-center justify-center gap-2">
            ...
            <p className="text-sm md:text-base lg:text-lg text-white/90 max-w-3xl mx-auto leading-relaxed px-2">
              Discover premium hostels designed for working professionals with modern amenities and convenient locations
            </p>
