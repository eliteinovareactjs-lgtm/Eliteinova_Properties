...
import CoLivingSpaceFilter from "../../components/filters/Hostel/CoLivingSpaceFilter";
import CoLivingSpace from "../../components/propertycard/Hostel/CoLivingSpace";
...
const CoLivingSpacePage = () => {
  ...
  const [activeHostelType, setActiveHostelType] = useState("Co Living Space");
  ...
  useEffect(() => {
    ...
    if (currentPath === "/hostel/co-living-space") {
      setActiveHostelType("Co Living Space");
    }
  }, [location.pathname]);
  ...
  const handleFilterChange = (filters) => {
    ...
    console.log("Co-Living Space filters applied:", filters);
  };
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search co-living spaces by city, locality, or landmark"
            ...
            <div className="flex flex-row min-h-[170px] sm:min-h-[220px] md:min-h-[280px] lg:min-h-[330px]">
              ...
              <div className="flex flex-col justify-center w-[38%] sm:w-[37%] md:w-[36%] lg:w-[35%] shrink-0 px-2.5 sm:px-5 md:px-6 lg:px-10 py-2.5 sm:py-4 md:py-6 lg:py-7 z-20">
                ...
                <p className="mt-1 sm:mt-2 md:mt-2.5 lg:mt-3 max-w-[120px] sm:max-w-[200px] md:max-w-[280px] lg:max-w-[340px] text-[#31544E] text-[8px] sm:text-[10px] md:text-xs lg:text-sm leading-snug lg:leading-relaxed">
                  Discover modern co-living spaces with shared
                  amenities, community events, and flexible
                  leases.
                </p>
              ...
              <div className="relative overflow-hidden flex-1" style={{ aspectRatio: '16/8' }}>
                ...
                <img
                  src={bannerImg}
                  alt="Co-Living Space accommodation"
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
            ...
            <div className="hidden lg:block lg:w-1/3 lg:relative">
              <div className="lg:sticky lg:top-[110px] lg:max-h-[calc(100vh-130px)] lg:overflow-y-auto lg:scrollbar-hide animate-slide-in-right">
                <CoLivingSpaceFilter onFilterChange={handleFilterChange} />
              </div>
            </div>
...
export default CoLivingSpacePage;