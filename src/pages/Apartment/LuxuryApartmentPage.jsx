...
import LuxuryApartmentFilter from "../../components/filters/Apartment/LuxuryApartmentFilter";
import LuxuryApartment from "../../components/propertycard/Apartment/LuxuryApartment";
            ...
            <div className="grid lg:grid-cols-[35%_65%] min-h-[330px]">
              ...
              <div className="flex flex-col justify-center px-7 lg:px-10 py-7 z-20">
                ...
                <p className="mt-3 max-w-[340px] text-[#31544E] text-sm leading-relaxed">
                  Discover premium luxury apartments,
                  high-end condos and elite living spaces in prime
                  locations.
                </p>
