...
import LeaseApartmentFilter from "../../components/filters/Apartment/LeaseApartmentFilter";
import LeaseApartment from "../../components/propertycard/Apartment/LeaseApartment";
            ...
            <div className="grid lg:grid-cols-[35%_65%] min-h-[330px]">
              ...
              <div className="flex flex-col justify-center px-7 lg:px-10 py-7 z-20">
                ...
                <p className="mt-3 max-w-[340px] text-[#31544E] text-sm leading-relaxed">
                  Discover premium lease apartments,
                  condos and long-term rental spaces in prime
                  locations.
                </p>
            ...
            <div className="md:hidden space-y-3">
              <div className="flex gap-2 items-center">
                ...
                <div className="relative flex-1 group">
                  ...
                  <input
                    type="text"
                    placeholder="Search lease apartments..."
