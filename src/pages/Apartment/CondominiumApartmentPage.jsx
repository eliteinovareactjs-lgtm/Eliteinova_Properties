...
import CondominiumApartmentFilter from "../../components/filters/Apartment/CondominiumApartmentFilter";
import CondominiumApartment from "../../components/propertycard/Apartment/CondominiumApartment";
...
const CondominiumApartmentPage = () => {
  ...
  const [activeApartmentType, setActiveApartmentType] = useState("Condominium (Condo)");
            ...
            <div className="grid lg:grid-cols-[35%_65%] min-h-[330px]">
              ...
              <div className="flex flex-col justify-center px-7 lg:px-10 py-7 z-20">
                ...
                <p className="mt-3 max-w-[340px] text-[#31544E] text-sm leading-relaxed">
                  Discover premium condominium apartments,
                  modern condos and stylish living spaces in prime
                  locations.
                </p>
            ...
            <div className="md:hidden space-y-3">
              <div className="flex gap-2 items-center">
                ...
                <div className="relative flex-1 group">
                  ...
                  <input
                    type="text"
                    placeholder="Search condominium apartments..."
