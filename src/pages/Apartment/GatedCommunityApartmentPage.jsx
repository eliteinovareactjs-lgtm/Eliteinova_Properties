...
import GatedCommunityApartmentFilter from "../../components/filters/Apartment/GatedCommunityApartmentFilter";
import GatedCommunityApartment from "../../components/propertycard/Apartment/GatedCommunityApartment";
...
const GatedCommunityApartmentPage = () => {
  ...
  const [activeApartmentType, setActiveApartmentType] = useState("Gated Community Apartment");
            ...
            <div className="grid lg:grid-cols-[35%_65%] min-h-[330px]">
              ...
              <div className="flex flex-col justify-center px-7 lg:px-10 py-7 z-20">
                ...
                <p className="mt-3 max-w-[340px] text-[#31544E] text-sm leading-relaxed">
                  Discover premium gated community apartments,
                  condos and secure living spaces in prime
                  locations.
                </p>
            ...
            <div className="hidden md:block space-y-3.5">
              <div className="flex gap-3.5 items-center">
                ...
                <div className="relative flex-1 group">
                  ...
                  <input
                    type="text"
                    placeholder="Search gated community apartments by city, locality, or landmark"
            ...
            <div className="md:hidden space-y-3">
              <div className="flex gap-2 items-center">
                ...
                <div className="relative flex-1 group">
                  ...
                  <input
                    type="text"
                    placeholder="Search gated community apartments..."
