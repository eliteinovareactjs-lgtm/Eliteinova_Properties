...
const ShoppingComplexLandPage = () => {
  ...
  useEffect(() => {
    ...
    else { setActiveLandType("Shopping Complex Land"); }
  }, [location.pathname]);
            ...
            <div className="flex flex-row min-h-[170px] sm:min-h-[220px] md:min-h-[280px] lg:min-h-[330px]">
              ...
              <div className="flex flex-col justify-center w-[38%] sm:w-[37%] md:w-[36%] lg:w-[35%] shrink-0 px-2.5 sm:px-5 md:px-6 lg:px-10 py-2.5 sm:py-4 md:py-6 lg:py-7 z-20">
                <h1 className="leading-none">
                  ...
                  <span className="block text-[16px] sm:text-[24px] md:text-[36px] lg:text-[50px] font-black text-[#012D29] leading-tight">SHOPPING COMPLEX</span>
              ...
              <div className="relative overflow-hidden flex-1" style={{ aspectRatio: '16/8' }}>
                <img src={mainPropertyImage} alt="Shopping Complex Land" className="absolute inset-0 w-full h-full object-cover object-top brightness-75" />
