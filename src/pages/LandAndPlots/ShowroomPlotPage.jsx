...
const ShowroomPlotPage = () => {
  ...
  useEffect(() => {
    ...
    else { setActiveLandType("Showroom Plot"); }
  }, [location.pathname]);
          ...
          <div className="max-w-[1600px] mx-auto">
            <div className="flex flex-row min-h-[170px] sm:min-h-[220px] md:min-h-[280px] lg:min-h-[330px]">
              ...
              <div className="relative overflow-hidden flex-1" style={{ aspectRatio: '16/8' }}>
                <img src={mainPropertyImage} alt="Showroom Plot" className="absolute inset-0 w-full h-full object-cover object-top brightness-75" />
