// AgriculturalLandPage.jsx
import React, { useState, useEffect } from "react";
import { ChevronDown, Search, Home, MapPin, Star, Filter, X, Building, Landmark, Warehouse, Building2, Store, Factory, Hotel, Briefcase, Trees, Sprout, Heart, School, Layers, ChevronRight, Compass, Users } from "lucide-react";
...
import AgriculturalLand from "../../components/propertycard/LandAndPlots/AgriculturalLand";

const AgriculturalLandPage = () => {
  const navigate = useNavigate();
  const location = useLocation();
  const [activeButton, setActiveButton] = useState("Buy");
  const [activeLandType, setActiveLandType] = useState("Agricultural Land");
  ...
  // Main categories with submenus + images - SAME AS LANDANDPLOTSPAGE
  ...
  useEffect(() => {
    ...
    if (activeType) { setActiveLandType(activeType.name); } else { setActiveLandType("Agricultural Land"); }
  }, [location.pathname]);
            ...
            <div className="flex flex-row min-h-[170px] sm:min-h-[220px] md:min-h-[280px] lg:min-h-[330px]">
              ...
              <div className="flex flex-col justify-center w-[38%] sm:w-[37%] md:w-[36%] lg:w-[35%] shrink-0 px-2.5 sm:px-5 md:px-6 lg:px-10 py-2.5 sm:py-4 md:py-6 lg:py-7 z-20">
                <h1 className="leading-none">
                  ...
                  <span className="block text-[12px] sm:text-[17px] md:text-[23px] lg:text-[30px] font-bold text-[#012D29] leading-tight">LAND FOR SALE</span>
                </h1>
              ...
              <div className="relative overflow-hidden flex-1" style={{ aspectRatio: '16/8' }}>
                <img src={mainPropertyImage} alt="Agricultural Land" className="absolute inset-0 w-full h-full object-cover object-top brightness-75" />
        ...
        <div className="bg-gradient-to-r from-teal-50/95 via-emerald-50/95 to-teal-50/95 backdrop-blur-xl shadow-2xl sticky top-0 z-40 border-b border-teal-200/30 transition-all duration-500">
          <div className="max-w-none mx-auto px-6 py-3.5">
            <div className="hidden md:block space-y-3.5">
              ...
              {/* ====== LAND CATEGORIES - EXACT SAME SIZE AS LANDANDPLOTSPAGE ====== */}
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Label - SAME AS LANDANDPLOTSPAGE */}
                        <span
