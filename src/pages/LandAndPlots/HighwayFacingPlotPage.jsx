...
import HighwayFacingPlotFilter from "../../components/filters/LandAndPlots/HighwayFacingPlotFilter";
import HighwayFacingPlot from "../../components/propertycard/LandAndPlots/HighwayFacingPlot";
...
const HighwayFacingPlotPage = () => {
  ...
  const SearchBar = () => (
    <div className="relative flex-1 group">
      ...
      <input
        type="text"
        placeholder="Search highway facing plots by city, locality, or project name"
            ...
            <div className="flex flex-row min-h-[170px] sm:min-h-[220px] md:min-h-[280px] lg:min-h-[330px]">
              ...
              <div className="flex flex-col justify-center w-[38%] sm:w-[37%] md:w-[36%] lg:w-[35%] shrink-0 px-2.5 sm:px-5 md:px-6 lg:px-10 py-2.5 sm:py-4 md:py-6 lg:py-7 z-20">
                <h1 className="leading-none">
                  ...
                  <span className="block text-[16px] sm:text-[24px] md:text-[36px] lg:text-[50px] font-black text-[#012D29] leading-tight">HIGHWAY</span>
                  <span className="block text-[12px] sm:text-[17px] md:text-[23px] lg:text-[30px] font-bold text-[#012D29] leading-tight">FACING PLOTS</span>
                </h1>
                <p className="mt-1 sm:mt-2 md:mt-2.5 lg:mt-3 max-w-[120px] sm:max-w-[200px] md:max-w-[280px] lg:max-w-[340px] text-[#31544E] text-[8px] sm:text-[10px] md:text-xs lg:text-sm leading-snug lg:leading-relaxed">
                  Discover premium highway facing plots for your dream project.
                </p>
                <button
              ...
              <div className="relative overflow-hidden flex-1" style={{ aspectRatio: '16/8' }}>
                <img src={mainPropertyImage} alt="Highway Facing Plot" className="absolute inset-0 w-full h-full object-cover object-top brightness-75" />
