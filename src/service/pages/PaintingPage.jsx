// src/service/pages/PaintingPage.jsx
...
const subcategories = [
  {
    ...
    description:
      "Premium interior wall painting with color consultation and finishing.",
    icon: "🎨",
    price: "From ₹18/sq.ft",
    projects: "1.2K+",
  },
  ...
  {
    id: 3,
    title: "Texture & Stencil",
    description:
      "Designer textures, stencils, and 3D wall art for unique spaces.",
    icon: "🖌️",
    price: "From ₹45/sq.ft",
    projects: "340+",
  },
  {
    ...
    description:
      "Anti-damp, waterproof, and anti-fungal treatments for walls.",
    icon: "🛡️",
    price: "From ₹32/sq.ft",
    projects: "510+",
  },
  {
    ...
    description:
      "Pu polish, melamine, and enamel finishes for wood and metal.",
    icon: "🪵",
    price: "From ₹55/sq.ft",
    projects: "290+",
  },
  {
    ...
    description:
      "Large-scale painting for offices, malls, hotels, and industrial spaces.",
    icon: "🏢",
    price: "Custom Quote",
    projects: "180+",
  },
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#00695C] via-[#26A69A] to-[#004D40] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-20">
          ...
          <p className="text-white/90 max-w-2xl text-lg">
            Beautiful finishes, expert craftsmanship — explore our painting
            subcategories.
          </p>
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            {[
              ...
              { icon: <Users className="w-3.5 h-3.5" />, text: "220+ Pros" },
              { icon: <Clock className="w-3.5 h-3.5" />, text: "30 min Response" },
            ].map((chip, i) => (
              <span
                key={i}
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            Choose the painting service that fits your needs.
          </p>
        </div>
