// src/service/pages/PlumbingPage.jsx
...
const subcategories = [
  {
    id: 1,
    title: "Leak Repair",
    description: "Quick fix for leaking taps, pipes, tanks, and fittings.",
    icon: "💧",
    price: "From ₹199",
    projects: "1.8K+",
  },
  {
    ...
    description:
      "Installation and replacement of taps, mixers, and shower fittings.",
    icon: "🚿",
    price: "From ₹299",
    projects: "950+",
  },
  {
    id: 3,
    title: "Toilet & Bathroom Fittings",
    description:
      "WC, washbasin, commode, and complete bathroom fittings setup.",
    icon: "🚽",
    price: "From ₹499",
    projects: "720+",
  },
  {
    ...
    description:
      "Tank cleaning, motor installation, and pump repair services.",
    icon: "⚙️",
    price: "From ₹599",
    projects: "450+",
  },
  {
    id: 5,
    title: "Drainage & Pipe Work",
    description:
      "Blockage clearing, pipeline installation, and drainage solutions.",
    icon: "🔧",
    price: "From ₹399",
    projects: "610+",
  },
  {
    id: 6,
    title: "Full Plumbing Setup",
    description:
      "End-to-end plumbing for new homes, offices, and commercial spaces.",
    icon: "🏢",
    price: "Custom Quote",
    projects: "230+",
  },
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#00695C] via-[#26A69A] to-[#004D40] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-20">
          ...
          <p className="text-white/90 max-w-2xl text-lg">
            Fix it right the first time — explore our plumbing subcategories.
          </p>

          <div className="flex flex-wrap gap-3 mt-6">
            {[
              { icon: <Star className="w-3.5 h-3.5" />, text: "4.7 Rating" },
              { icon: <Users className="w-3.5 h-3.5" />, text: "310+ Pros" },
              { icon: <Clock className="w-3.5 h-3.5" />, text: "45 min Response" },
            ].map((chip, i) => (
              <span
                key={i}
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            Choose the plumbing service that fits your needs.
          </p>
        </div>
