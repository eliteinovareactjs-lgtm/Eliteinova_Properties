// src/service/pages/CleaningPage.jsx
...
const subcategories = [
  {
    ...
    description:
      "Complete deep cleaning of your home including kitchen, bathrooms, and rooms.",
    icon: "🏠",
    price: "From ₹1,499",
    projects: "2.8K+",
  },
  {
    ...
    description: "Degreasing, chimney, cabinets, and appliance deep cleaning.",
    icon: "🍳",
    price: "From ₹699",
    projects: "1.4K+",
  },
  {
    ...
    description:
      "Tile scrubbing, stain removal, and sanitization of bathrooms.",
    icon: "🚿",
    price: "From ₹499",
    projects: "1.9K+",
  },
  {
    ...
    description:
      "Shampooing, vacuuming, and stain removal for sofas and carpets.",
    icon: "🛋️",
    price: "From ₹599",
    projects: "980+",
  },
  {
    ...
    description:
      "Daily or one-time commercial cleaning for offices and workspaces.",
    icon: "🏢",
    price: "Custom Quote",
    projects: "520+",
  },
  {
    ...
    title: "Pest Control",
    description:
      "Safe and effective pest control for homes and commercial spaces.",
    icon: "🐜",
    price: "From ₹899",
    projects: "760+",
  },
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#00695C] via-[#26A69A] to-[#004D40] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-20">
          ...
          <p className="text-white/90 max-w-2xl text-lg">
            Sparkling clean, every time — explore our cleaning subcategories.
          </p>

          <div className="flex flex-wrap gap-3 mt-6">
            {[
              { icon: <Star className="w-3.5 h-3.5" />, text: "4.9 Rating" },
              { icon: <Users className="w-3.5 h-3.5" />, text: "420+ Pros" },
