// src/service/pages/ConstructionPage.jsx
...
const subcategories = [
  {
    ...
    description:
      "Complete home construction from foundation to finish — independent houses, villas, and duplexes.",
    icon: "🏠",
  ...
  },
  {
    ...
    description:
      "Office buildings, retail spaces, showrooms, and commercial complexes built to spec.",
    icon: "🏢",
    price: "From ₹1,799/sq.ft",
    projects: "180+",
  },
  {
    id: 3,
    ...
    description:
      "Hassle-free end-to-end construction with materials, labor, and project management included.",
    icon: "🔑",
    price: "From ₹1,899/sq.ft",
    projects: "240+",
  },
  {
    id: 4,
    ...
    description:
      "Transform existing spaces with structural changes, modern upgrades, and redesigns.",
    icon: "🔨",
    price: "From ₹899/sq.ft",
    projects: "410+",
  },
  {
    id: 5,
    ...
    description:
      "Foundation work, RCC structures, compound walls, and heavy civil engineering projects.",
    icon: "⚙️",
    price: "Custom Quote",
    projects: "150+",
  },
  {
    ...
    description:
      "Dedicated supervision, timeline tracking, quality checks, and vendor coordination.",
    icon: "📋",
    price: "From 5% of budget",
    projects: "200+",
  },
];
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#00695C] via-[#26A69A] to-[#004D40] text-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-20">
          ...
          <p className="text-white/90 max-w-2xl text-lg">
            From foundation to finish — explore our complete range of
            construction subcategories.
          </p>

          <div className="flex flex-wrap gap-3 mt-6">
            {[
              { icon: <Star className="w-3.5 h-3.5" />, text: "4.9 Rating" },
              { icon: <Users className="w-3.5 h-3.5" />, text: "150+ Pros" },
              { icon: <Clock className="w-3.5 h-3.5" />, text: "2 hr Response" },
            ].map((chip, i) => (
              <span
                key={i}
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-6 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto">
            Choose the specific construction service you need.
          </p>
        </div>
